...
describe('Transaction DB Update test', () => {
  it('closed transaction db to entity ', () => {
    ...
    const transaction = new Transaction('12345', fromDB);
  ...
  it('closed transaction with meter values to entity ', () => {
    ...
    const transaction = new Transaction('1234', fromDB);
    transaction.stopTransaction(transaction.getUser(), '7099C291', 4996, new Date('2018-08-03T17:47:49.000Z'));
    expect(transaction.getModel()).to.deep.equal({
      'chargeBoxID': 'SAP-Mougins-06',
      'connectorId': 2,
      'id': 112940,
    ...
    const toDB = {};
    Database.updateTransaction(transaction.getModel(), toDB, false);
