...
describe('OCPP Service (all versions)', () => {
  ...
  describe('Without any component (utnothing)', () => {
    beforeAll(async () => {
      ...
      testData.ocppCommonTests = new OCPPCommonTests(
        testData.tenantContext,
    ...
    describe('For OCPP Version 1.5 (SOAP)', () => {
      beforeAll(() => {
        testData.chargingStationContext = testData.tenantContext.getChargingStationContext(
          ContextDefinition.CHARGING_STATION_CONTEXTS.UNASSIGNED_OCPP15
        );
      ...
      describe('Where basic user', () => {
        beforeAll(() => {
          testData.ocppCommonTests.setUsers(
            testData.tenantContext.getUserContext(
              ContextDefinition.USER_CONTEXTS.BASIC_USER_UNASSIGNED
            )
          );
        });
    ...
    describe('For OCPP Version 1.6 (JSON)', () => {
      beforeAll(() => {
        testData.chargingStationContext = testData.tenantContext.getChargingStationContext(
          ContextDefinition.CHARGING_STATION_CONTEXTS.UNASSIGNED_OCPP16
        );
        testData.ocppCommonTests.setChargingStation(testData.chargingStationContext);
      });
  ...
  describe('With component Organization only (utorg)', () => {
    ...
    describe('For OCPP Version 1.5 (SOAP)', () => {
      describe('With unregistered charger', () => {
        beforeAll(() => {
          testData.chargingStationContext = testData.tenantContext.getChargingStationContext(
            ContextDefinition.CHARGING_STATION_CONTEXTS.UNREGISTERED_OCPP15
          );
          testData.ocppCommonTests.setChargingStation(testData.chargingStationContext);
        });
      ...
      describe('With invalid charging station identifier', () => {
        beforeAll(() => {
          testData.chargingStationContext = testData.tenantContext.getChargingStationContext(
            ContextDefinition.CHARGING_STATION_CONTEXTS.INVALID_IDENTIFIER_OCPP15
          );
          testData.ocppCommonTests.setChargingStation(testData.chargingStationContext);
        });
      ...
      describe('With charger assigned to a site area', () => {
        ...
        describe('Where unassigned admin user', () => {
          beforeAll(() => {
            testData.ocppCommonTests.setUsers(
              testData.tenantContext.getUserContext(
                ContextDefinition.USER_CONTEXTS.ADMIN_UNASSIGNED
              )
            );
          });
    ...
    describe('For OCPP Version 1.6 (JSON)', () => {
      describe('With unregistered charger', () => {
        beforeAll(() => {
          testData.chargingStationContext = testData.tenantContext.getChargingStationContext(
            ContextDefinition.CHARGING_STATION_CONTEXTS.UNREGISTERED_OCPP16
          );
          testData.ocppCommonTests.setChargingStation(testData.chargingStationContext);
        });
      ...
      describe('With invalid charging station identifier', () => {
        beforeAll(() => {
          testData.chargingStationContext = testData.tenantContext.getChargingStationContext(
            ContextDefinition.CHARGING_STATION_CONTEXTS.INVALID_IDENTIFIER_OCPP16
          );
          testData.ocppCommonTests.setChargingStation(testData.chargingStationContext);
        });
