...
export default class OICPEndpointApi extends CrudApi {
  ...
  public async readById(id: string) {
    return super.readById(id, this.buildRestEndpointUrl(ServerRoute.REST_OICP_ENDPOINT, { id }));
  }

  public async readAll(params, paging = TestConstants.DEFAULT_PAGING, ordering = TestConstants.DEFAULT_ORDERING) {
    return super.readAll(params, paging, ordering, this.buildRestEndpointUrl(ServerRoute.REST_OICP_ENDPOINTS));
  }

  public async create(data: OCPIEndpoint) {
    return super.create(data, this.buildRestEndpointUrl(ServerRoute.REST_OICP_ENDPOINTS));
  }

  public async update(data: OCPIEndpoint) {
    return super.update(data, this.buildRestEndpointUrl(ServerRoute.REST_OICP_ENDPOINT, { id: data.id }));
  }

  public async delete(id: string) {
    return super.delete(id, this.buildRestEndpointUrl(ServerRoute.REST_OICP_ENDPOINT, { id }));
  }

  public async register(id: string) {
    return super.update(id, this.buildRestEndpointUrl(ServerRoute.REST_OICP_ENDPOINT_REGISTER, { id }));
  }
