...
export default class TransactionApi extends CrudApi {
  ...
  public async readById(id) {
    return super.readById(
      id,
      `${this.buildRestEndpointUrl(RESTServerRoute.REST_TRANSACTION, { id })}?WithUser=true`
    );
  }

  public async readAllActive(
    params,
  ...
  public async readAllInError(
    ...
    return super.readAll(
      ...
      paging,
      ordering,
      this.buildRestEndpointUrl(RESTServerRoute.REST_TRANSACTIONS_IN_ERROR)
    );
  }
  ...
  public async readAllConsumption(params) {
    ...
    return super.read(
      ...
      `${this.buildRestEndpointUrl(RESTServerRoute.REST_TRANSACTION_CONSUMPTIONS, {
        id,
      })}?WithUser=true&LoadAllConsumptions=true`
    );
  }
  ...
  public async readAllToRefund(params) {
    return super.readAll(
      params,
      TestConstants.ADVANCED_PAGING,
      TestConstants.DEFAULT_ORDERING,
      this.buildRestEndpointUrl(RESTServerRoute.REST_TRANSACTIONS_REFUND)
    );
  }

  public async readAllRefundReports(
    params,
    paging = TestConstants.DEFAULT_PAGING,
    ordering = TestConstants.DEFAULT_ORDERING
  ) {
    return super.readAll(
      ...
      paging,
      ordering,
      this.buildRestEndpointUrl(RESTServerRoute.REST_TRANSACTIONS_REFUND_REPORTS)
    );
  }
  ...
  public async exportTransactionsToRefund(params) {
    return super.read(
      params,
      this.buildRestEndpointUrl(RESTServerRoute.REST_TRANSACTIONS_REFUND_EXPORT)
    );
  }
  ...
  public async softStopTransaction(params) {
    return super.update(
      params,
      this.buildRestEndpointUrl(RESTServerRoute.REST_TRANSACTION_SOFT_STOP, { id: params.ID })
    );
  }
}
