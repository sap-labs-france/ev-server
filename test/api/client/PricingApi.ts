...
export default class PricingApi extends CrudApi {
  ...
  public async readPricingDefinitions(
    params,
    ...
    return super.readAll(
      ...
      paging,
      ordering,
      this.buildRestEndpointUrl(RESTServerRoute.REST_PRICING_DEFINITIONS) +
  ...
  public async readPricingDefinition(id: string) {
    return super.readById(
      id,
      this.buildRestEndpointUrl(RESTServerRoute.REST_PRICING_DEFINITION, { id }) +
        '?WithEntityInformation=true'
    );
  }
  ...
  public async updatePricingDefinition(data: PricingDefinition) {
    return super.update(
      data,
      this.buildRestEndpointUrl(RESTServerRoute.REST_PRICING_DEFINITION, { id: data.id })
    );
  }
