...
export default class AssetApi extends CrudApi {
  ...
  public async readAll(
    ...
    return super.readAll(
      ...
      paging,
      ordering,
      this.buildRestEndpointUrl(RESTServerRoute.REST_ASSETS)
    );
  }
  ...
  public async update(data: Asset): Promise<any> {
    return super.update(
      data,
      this.buildRestEndpointUrl(RESTServerRoute.REST_ASSET, { id: data.id })
    );
  }
  ...
  public async readAllInError(
    ...
    return super.readAll(
      ...
      paging,
      ordering,
      this.buildRestEndpointUrl(RESTServerRoute.REST_ASSETS_IN_ERROR)
    );
  }
  ...
  public async checkAssetConnectorLink(id: string): Promise<any> {
    return super.read(
      id,
      this.buildRestEndpointUrl(RESTServerRoute.REST_ASSET_CHECK_CONNECTION, { id })
    );
  }
  ...
  public async retrieveLatestConsumption(id: string): Promise<any> {
    return super.read(
      id,
      this.buildRestEndpointUrl(RESTServerRoute.REST_ASSET_RETRIEVE_CONSUMPTION, { id })
    );
  }
}
