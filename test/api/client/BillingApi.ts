...
export default class BillingApi extends CrudApi {
  ...
  public async downloadInvoiceDocument(params?) {
    return super.read(
      params,
      super.buildRestEndpointUrl(RESTServerRoute.REST_BILLING_DOWNLOAD_INVOICE, params)
    );
  }
  ...
  public async getBillingSetting(params?) {
    return super.read(
      params,
      super.buildRestEndpointUrl(RESTServerRoute.REST_BILLING_SETTING, params)
    );
  }
  ...
  public async checkBillingConnection(params?) {
    return super.create(
      params,
      super.buildRestEndpointUrl(RESTServerRoute.REST_BILLING_CHECK, params)
    );
  }
  ...
  public async clearBillingTestData(params?) {
    return super.create(
      params,
      super.buildRestEndpointUrl(RESTServerRoute.REST_BILLING_CLEAR_TEST_DATA, params)
    );
  }
  ...
  public async readInvoices(
    ...
    return super.readAll(
      ...
      paging,
      ordering,
      super.buildRestEndpointUrl(RESTServerRoute.REST_BILLING_INVOICES)
    );
  }
  ...
  public async readInvoice(id: string) {
    return super.read(
      {},
      super.buildRestEndpointUrl(RESTServerRoute.REST_BILLING_INVOICE, { invoiceID: id })
    );
  }
  ...
  public async refreshBillingAccount(params) {
    return super.patch(
      params,
      super.buildUtilRestEndpointUrl(RESTServerRoute.REST_BILLING_ACCOUNT_REFRESH, {
        id: params.accountID,
      })
    );
  }
  ...
  public async activateBillingAccount(params) {
    return super.patch(
      params,
      super.buildUtilRestEndpointUrl(RESTServerRoute.REST_BILLING_ACCOUNT_ACTIVATE, {
        id: params.accountID,
      })
    );
  }

  public async readBillingAccounts(
    params,
    paging = TestConstants.DEFAULT_PAGING,
    ordering = TestConstants.DEFAULT_ORDERING
  ) {
    return super.readAll(
      ...
      paging,
      ordering,
      super.buildRestEndpointUrl(RESTServerRoute.REST_BILLING_ACCOUNTS)
    );
  }
  ...
  public async onboardBillingAccount(id: string) {
    return super.patch(
      {},
      super.buildRestEndpointUrl(RESTServerRoute.REST_BILLING_ACCOUNT_ONBOARD, { id })
    );
  }
  ...
  public async readTransfers(
    ...
    return super.readAll(
      ...
      paging,
      ordering,
      super.buildRestEndpointUrl(RESTServerRoute.REST_BILLING_TRANSFERS)
    );
  }
  ...
  public async readTransfer(id: string) {
    return super.read(
      {},
      super.buildRestEndpointUrl(RESTServerRoute.REST_BILLING_TRANSFER, { id })
    );
  }
  ...
  public async finalizeTransfer(id) {
    return super.patch(
      {},
      super.buildRestEndpointUrl(RESTServerRoute.REST_BILLING_TRANSFER_FINALIZE, { id })
    );
  }
  ...
  public async sendTransfer(id) {
    return super.patch(
      {},
      super.buildRestEndpointUrl(RESTServerRoute.REST_BILLING_TRANSFER_SEND, { id })
    );
  }
}
