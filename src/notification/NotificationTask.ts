...
export default interface NotificationTask {
  ...
  sendBillingSubAccountCreationLink(data: BillingSubAccountCreationLink, user: User, tenant: Tenant, severity: NotificationSeverity): Promise<void>;
