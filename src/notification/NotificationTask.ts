...
export default interface NotificationTask {
  ...
  sendOICPPatchChargingStationsStatusesError(
    data: OICPPatchChargingStationsStatusesErrorNotification,
    user: User,
    tenant: Tenant,
    severity: NotificationSeverity
  ): Promise<NotificationResult>;
  sendOICPPatchChargingStationsError(
  ...
  sendBillingInvoiceSynchronizationFailed(
  ...
  sendEndUserErrorNotification(
    data: Partial<EndUserErrorNotification>,
    user: User,
    tenant: Tenant,
    severity: NotificationSeverity
  ): Promise<NotificationResult>;
  ...
  sendBillingAccountCreationLink(
    data: BillingAccountCreationLinkNotification,
    user: User,
    tenant: Tenant,
    severity: NotificationSeverity
  ): Promise<NotificationResult>;
  sendBillingAccountActivationNotification(
