...
const pushEndpointPathURI = `/v1/api/chargingstations/certificates/install`;
const deleteEndpointPathURI = `/v1/api/chargingstations/certificates/delete`;
const pullEndpointPathURI = `/v1/api/chargingstations/certificates`;
