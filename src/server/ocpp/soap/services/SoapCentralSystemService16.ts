  ...
  CentralSystemService: {
    ...
    CentralSystemServiceSoap12: {
      ...
      Authorize: function (args, callback, headers: OCPPHeader, req): void {
        ...
        // Check SOAP params
        OCPPUtils.checkChargingStationAndEnrichSoapOcppHeaders(Command.AUTHORIZE, headers, req)
          .then(async () => {
            // Trace
            ...
            // Handle
            const result = await global.centralSystemSoapServer
              .getChargingStationService(OCPPVersion.VERSION_16)
              .handleAuthorize(headers, args);
            const response = {
              authorizeResponse: {
                idTagInfo: {
          ...
          .catch(async (error) => {
            ...
            await Logging.logException(
              ...
              MODULE_NAME,
              'Authorize',
              headers.tenantID ?? Constants.DEFAULT_TENANT_ID
            );
            // Trace
            await Logging.traceOcppMessageResponse(
              MODULE_NAME,
      ...
      BootNotification: function (args, callback, headers: OCPPHeader, req): void {
        ...
        // Check SOAP params
        OCPPUtils.checkChargingStationAndEnrichSoapOcppHeaders(
          ...
          .then(async () => {
            ...
            const result = await global.centralSystemSoapServer
              .getChargingStationService(OCPPVersion.VERSION_16)
              .handleBootNotification(headers, args);
            const response = {
      ...
      DataTransfer: function (args, callback, headers: OCPPHeader, req): void {
        const request = { ...headers, ...args };
        // Check SOAP params
        OCPPUtils.checkChargingStationAndEnrichSoapOcppHeaders(Command.DATA_TRANSFER, headers, req)
          .then(async () => {
            // Trace
            const performanceTracingData = await Logging.traceOcppMessageRequest(
              MODULE_NAME,
            ...
            const result = await global.centralSystemSoapServer
              .getChargingStationService(OCPPVersion.VERSION_16)
              .handleDataTransfer(headers, args);
            const response = {
      ...
      DiagnosticsStatusNotification: function (args, callback, headers: OCPPHeader, req): void {
        ...
        OCPPUtils.checkChargingStationAndEnrichSoapOcppHeaders(
          ...
          .then(async () => {
            ...
            // Handle
            await global.centralSystemSoapServer
              .getChargingStationService(OCPPVersion.VERSION_16)
              .handleDiagnosticsStatusNotification(headers, args);
            const response = {
      ...
      FirmwareStatusNotification: function (args, callback, headers: OCPPHeader, req): void {
        ...
        OCPPUtils.checkChargingStationAndEnrichSoapOcppHeaders(
          ...
          .then(async () => {
            ...
            await global.centralSystemSoapServer
              .getChargingStationService(OCPPVersion.VERSION_16)
              .handleFirmwareStatusNotification(headers, args);
            const response = {
      ...
      Heartbeat: function (args, callback, headers: OCPPHeader, req): void {
        const request = { ...headers, ...args };
        // Check SOAP params
        OCPPUtils.checkChargingStationAndEnrichSoapOcppHeaders(Command.HEARTBEAT, headers, req)
          .then(async () => {
            // Trace
            const performanceTracingData = await Logging.traceOcppMessageRequest(
              MODULE_NAME,
      ...
      MeterValues: function (args, callback, headers: OCPPHeader, req): void {
        const request = { ...headers, ...args };
        // Check SOAP params
        OCPPUtils.checkChargingStationAndEnrichSoapOcppHeaders(Command.METER_VALUES, headers, req)
          .then(async () => {
            // Trace
            const performanceTracingData = await Logging.traceOcppMessageRequest(
              MODULE_NAME,
            ...
            await global.centralSystemSoapServer
              .getChargingStationService(OCPPVersion.VERSION_16)
              .handleMeterValues(headers, args);
            const response = {
              meterValuesResponse: {},
            };
            callback(response);
      ...
      StartTransaction: function (args, callback, headers: OCPPHeader, req): void {
        ...
        OCPPUtils.checkChargingStationAndEnrichSoapOcppHeaders(
          ...
          .then(async () => {
            ...
            const result = await global.centralSystemSoapServer
              .getChargingStationService(OCPPVersion.VERSION_16)
              .handleStartTransaction(headers, args);
            const response = {
      ...
      StatusNotification: function (args, callback, headers: OCPPHeader, req): void {
        ...
        OCPPUtils.checkChargingStationAndEnrichSoapOcppHeaders(
          ...
          .then(async () => {
            ...
            await global.centralSystemSoapServer
              .getChargingStationService(OCPPVersion.VERSION_16)
              .handleStatusNotification(headers, args);
            const response = {
      ...
      StopTransaction: function (args, callback, headers: OCPPHeader, req): void {
        ...
        OCPPUtils.checkChargingStationAndEnrichSoapOcppHeaders(
          ...
          .then(async () => {
            ...
            const result = await global.centralSystemSoapServer
              .getChargingStationService(OCPPVersion.VERSION_16)
              .handleStopTransaction(headers, args);
            const response = {
