...
export default class OCPPUtils {
  ...
  public static async requestAndSaveChargingStationOcppParameters(tenantID: string,
    ...
    try {
      ...
      const chargingStationOcppParameters: ChargingStationOcppParameters = {
        ...
        configuration: ocppConfiguration.configurationParams,
        timestamp: new Date()
      };
      // Set default?
  ...
  private static isOcppParamForPowerLimitationKey(ocppParameterKey: string, chargingStation: ChargingStation) {
