...
class RequestMapper {
  ...
  private actions = new Array<
    (action: ServerAction, req: Request, res: Response, next: NextFunction) => void | Promise<void>
  >();
    ...
    switch (httpVerb) {
      ...
      case 'POST':
        ...
        this.registerJsonActionsPaths({
          [ServerAction.ADD_CHARGING_STATIONS_TO_SITE_AREA]:
            SiteAreaService.handleAssignChargingStationsToSiteArea.bind(this),
          [ServerAction.REMOVE_CHARGING_STATIONS_FROM_SITE_AREA]:
            SiteAreaService.handleAssignChargingStationsToSiteArea.bind(this),
          ...
          [ServerAction.ADD_ASSET_TO_SITE_AREA]:
            SiteAreaService.handleAssignAssetsToSiteArea.bind(this),
          [ServerAction.REMOVE_ASSET_TO_SITE_AREA]:
            SiteAreaService.handleAssignAssetsToSiteArea.bind(this),
          ...
          [ServerAction.TRANSACTIONS_REFUND]:
            TransactionService.handleRefundTransactions.bind(this),
          [ServerAction.TRANSACTION_PUSH_CDR]:
            TransactionService.handlePushTransactionCdr.bind(this),
          [ServerAction.SYNCHRONIZE_REFUNDED_TRANSACTIONS]:
            TransactionService.handleSynchronizeRefundedTransactions.bind(this),
          [ServerAction.SETTING_CREATE]: SettingService.handleCreateSetting.bind(this),
          [ServerAction.BILLING_FORCE_SYNCHRONIZE_USER]:
            BillingService.handleForceSynchronizeUser.bind(this),
          [ServerAction.BILLING_SETUP_PAYMENT_METHOD]:
            BillingService.handleBillingSetupPaymentMethod.bind(this),
          [ServerAction.OCPI_ENDPOINT_CREATE]:
            OCPIEndpointService.handleCreateOcpiEndpoint.bind(this),
          [ServerAction.OCPI_ENDPOINT_PING]: OCPIEndpointService.handlePingOcpiEndpoint.bind(this),
          [ServerAction.OCPI_ENDPOINT_CHECK_CDRS]:
            OCPIEndpointService.handleCheckCdrsEndpoint.bind(this),
          [ServerAction.OCPI_ENDPOINT_CHECK_LOCATIONS]:
            OCPIEndpointService.handleCheckLocationsEndpoint.bind(this),
          [ServerAction.OCPI_ENDPOINT_CHECK_SESSIONS]:
            OCPIEndpointService.handleCheckSessionsEndpoint.bind(this),
          [ServerAction.OCPI_ENDPOINT_PULL_CDRS]:
            OCPIEndpointService.handlePullCdrsEndpoint.bind(this),
          [ServerAction.OCPI_ENDPOINT_PULL_LOCATIONS]:
            OCPIEndpointService.handlePullLocationsEndpoint.bind(this),
          [ServerAction.OCPI_ENDPOINT_PULL_SESSIONS]:
            OCPIEndpointService.handlePullSessionsEndpoint.bind(this),
          [ServerAction.OCPI_ENDPOINT_PULL_TOKENS]:
            OCPIEndpointService.handlePullTokensEndpoint.bind(this),
          [ServerAction.OCPI_ENDPOINT_SEND_EVSE_STATUSES]:
            OCPIEndpointService.handlePushEVSEStatusesOcpiEndpoint.bind(this),
          [ServerAction.OCPI_ENDPOINT_SEND_TOKENS]:
            OCPIEndpointService.handlePushTokensOcpiEndpoint.bind(this),
          [ServerAction.OCPI_ENDPOINT_GENERATE_LOCAL_TOKEN]:
            OCPIEndpointService.handleGenerateLocalTokenOcpiEndpoint.bind(this),
          [ServerAction.OICP_ENDPOINT_CREATE]:
            OICPEndpointService.handleCreateOicpEndpoint.bind(this),
          [ServerAction.OICP_ENDPOINT_PING]: OICPEndpointService.handlePingOicpEndpoint.bind(this),
          [ServerAction.OICP_ENDPOINT_SEND_EVSE_STATUSES]:
            OICPEndpointService.handleSendEVSEStatusesOicpEndpoint.bind(this),
          [ServerAction.OICP_ENDPOINT_SEND_EVSES]:
            OICPEndpointService.handleSendEVSEsOicpEndpoint.bind(this),
          [ServerAction.INTEGRATION_CONNECTION_CREATE]:
            ConnectionService.handleCreateConnection.bind(this),
          [ServerAction.CHARGING_STATION_REQUEST_OCPP_PARAMETERS]:
            ChargingStationService.handleRequestChargingStationOcppParameters.bind(this),
          [ServerAction.CAR_CREATE]: CarService.handleCreateCar.bind(this),
          [ServerAction.TAG_CREATE]: TagService.handleCreateTag.bind(this),
          [ServerAction.END_USER_REPORT_ERROR]:
            NotificationService.handleEndUserReportError.bind(this),
      ...
      case 'GET':
        ...
        this.registerJsonActionsPaths({
          ...
          [ServerAction.CHARGING_STATIONS]:
            ChargingStationService.handleGetChargingStations.bind(this),
          ...
          [ServerAction.RETRIEVE_ASSET_CONSUMPTION]:
            AssetService.handleRetrieveConsumption.bind(this),
          ...
          [ServerAction.SITE_AREA_CONSUMPTION]:
            SiteAreaService.handleGetSiteAreaConsumption.bind(this),
          ...
          [ServerAction.TRANSACTIONS_COMPLETED]:
            TransactionService.handleGetTransactionsCompleted.bind(this),
          [ServerAction.TRANSACTIONS_TO_REFUND]:
            TransactionService.handleGetTransactionsToRefund.bind(this),
          [ServerAction.TRANSACTIONS_TO_REFUND_EXPORT]:
            TransactionService.handleExportTransactionsToRefund.bind(this),
          [ServerAction.TRANSACTIONS_TO_REFUND_REPORTS]:
            TransactionService.handleGetRefundReports.bind(this),
          [ServerAction.TRANSACTIONS_EXPORT]:
            TransactionService.handleExportTransactions.bind(this),
          [ServerAction.TRANSACTIONS_ACTIVE]:
            TransactionService.handleGetTransactionsActive.bind(this),
          [ServerAction.TRANSACTIONS_IN_ERROR]:
            TransactionService.handleGetTransactionsInError.bind(this),
          [ServerAction.TRANSACTION_YEARS]: TransactionService.handleGetTransactionYears.bind(this),
          [ServerAction.TRANSACTION_OCPI_CDR_EXPORT]:
            TransactionService.handleExportTransactionOcpiCdr.bind(this),
          [ServerAction.CHARGING_STATION_CONSUMPTION_STATISTICS]:
            StatisticService.handleGetChargingStationConsumptionStatistics.bind(this),
          [ServerAction.CHARGING_STATION_USAGE_STATISTICS]:
            StatisticService.handleGetChargingStationUsageStatistics.bind(this),
          [ServerAction.CHARGING_STATION_INACTIVITY_STATISTICS]:
            StatisticService.handleGetChargingStationInactivityStatistics.bind(this),
          [ServerAction.CHARGING_STATION_TRANSACTIONS_STATISTICS]:
            StatisticService.handleGetChargingStationTransactionsStatistics.bind(this),
          [ServerAction.CHARGING_STATION_PRICING_STATISTICS]:
            StatisticService.handleGetChargingStationPricingStatistics.bind(this),
          [ServerAction.STATISTICS_EXPORT]: StatisticService.handleExportStatistics.bind(this),
          [ServerAction.USER_CONSUMPTION_STATISTICS]:
            StatisticService.handleGetUserConsumptionStatistics.bind(this),
          [ServerAction.USER_USAGE_STATISTICS]:
            StatisticService.handleGetUserUsageStatistics.bind(this),
          [ServerAction.USER_INACTIVITY_STATISTICS]:
            StatisticService.handleGetUserInactivityStatistics.bind(this),
          [ServerAction.USER_TRANSACTIONS_STATISTICS]:
            StatisticService.handleGetUserTransactionsStatistics.bind(this),
          [ServerAction.USER_PRICING_STATISTICS]:
            StatisticService.handleGetUserPricingStatistics.bind(this),
          [ServerAction.CHARGING_STATION_TRANSACTIONS]:
            TransactionService.handleGetChargingStationTransactions.bind(this),
          [ServerAction.TRANSACTION]: TransactionService.handleGetTransaction.bind(this),
          [ServerAction.TRANSACTION_CONSUMPTION]:
            TransactionService.handleGetTransactionConsumption.bind(this),
          [ServerAction.SETTING_BY_IDENTIFIER]:
            SettingService.handleGetSettingByIdentifier.bind(this),
          ...
          [ServerAction.CHECK_BILLING_CONNECTION]:
            BillingService.handleCheckBillingConnection.bind(this),
          ...
          [ServerAction.BILLING_DOWNLOAD_TRANSFER]:
            BillingService.handleTransferInvoiceDownload.bind(this),
          [ServerAction.BILLING_PAYMENT_METHODS]:
            BillingService.handleBillingGetPaymentMethods.bind(this),
      ...
      case 'PUT':
        ...
        this.registerJsonActionsPaths({
          ...
          [ServerAction.TRANSACTION_SOFT_STOP]:
            TransactionService.handleTransactionSoftStop.bind(this),
          [ServerAction.SETTING_UPDATE]: SettingService.handleUpdateSetting.bind(this),
          [ServerAction.OCPI_ENDPOINT_UPDATE]:
            OCPIEndpointService.handleUpdateOcpiEndpoint.bind(this),
          [ServerAction.OCPI_ENDPOINT_REGISTER]:
            OCPIEndpointService.handleRegisterOcpiEndpoint.bind(this),
          [ServerAction.OCPI_ENDPOINT_UNREGISTER]:
            OCPIEndpointService.handleUnregisterOcpiEndpoint.bind(this),
          [ServerAction.OICP_ENDPOINT_UPDATE]:
            OICPEndpointService.handleUpdateOicpEndpoint.bind(this),
          [ServerAction.OICP_ENDPOINT_REGISTER]:
            OICPEndpointService.handleRegisterOicpEndpoint.bind(this),
          [ServerAction.OICP_ENDPOINT_UNREGISTER]:
            OICPEndpointService.handleUnregisterOicpEndpoint.bind(this),
          [ServerAction.SYNCHRONIZE_CAR_CATALOGS]:
            CarService.handleSynchronizeCarCatalogs.bind(this),
      ...
      case 'DELETE':
        ...
        this.registerJsonActionsPaths({
          ...
          [ServerAction.TRANSACTIONS_DELETE]:
            TransactionService.handleDeleteTransactions.bind(this),
          [ServerAction.INTEGRATION_CONNECTION_DELETE]:
            ConnectionService.handleDeleteConnection.bind(this),
          [ServerAction.SETTING_DELETE]: SettingService.handleDeleteSetting.bind(this),
          [ServerAction.OCPI_ENDPOINT_DELETE]:
            OCPIEndpointService.handleDeleteOcpiEndpoint.bind(this),
          [ServerAction.OICP_ENDPOINT_DELETE]:
            OICPEndpointService.handleDeleteOicpEndpoint.bind(this),
          ...
          [ServerAction.BILLING_DELETE_PAYMENT_METHOD]:
            BillingService.handleBillingDeletePaymentMethod.bind(this),
        });
        break;
    }
  }
  ...
  public registerOneActionManyPaths(
    action: (
      action: ServerAction,
      req: Request,
      res: Response,
  ...
  public registerJsonActionsPaths(dict: {
    [key in ServerAction]?: (
      action: ServerAction,
      req: Request,
      res: Response,
...
export default class RestServerService {
  // Util Service
  public static async restServiceUtil(
    req: Request,
    res: Response,
    next: NextFunction
  ): Promise<void> {
    try {
      ...
      await Logging.logWarning({
        ...
        module: 'CentralRestServerService',
        method: 'restServiceUtil',
      });
      // Check Context
      switch (req.method) {
        // Create Request
  ...
  public static async restServiceSecured(
    req: Request,
    res: Response,
    next: NextFunction
  ): Promise<void> {
    ...
    try {
      // Get the action
      const handleRequest = RequestMapper.getInstanceFromHTTPVerb(req.method).getActionFromPath(
        action
      );
      // Execute
