    ...
    switch (httpVerb) {
      ...
      case 'GET':
        ...
        this.registerJsonActionsPaths({
          ...
          [ServerAction.BILLING_DOWNLOAD_TRANSFER]: BillingService.handleTransferInvoiceDownload.bind(this),
...
export default class RestServerService {
  ...
  public static async restServiceSecured(req: Request, res: Response, next: NextFunction): Promise<void> {
    ...
    Logging.beWarning()?.log({
      ...
      action: ServerAction.DEPRECATED_REST_ENDPOINT,
      module: 'CentralRestServerService', method: 'restServiceSecured',
    });
    // Check HTTP Verbs
