    ...
    switch (httpVerb) {
      ...
      case 'GET':
        ...
        this.registerJsonActionsPaths({
          ...
          ChargingStationSessionsStatistics: StatisticService.handleGetChargingStationSessionsStatistics,
          ...
          UserSessionsStatistics: StatisticService.handleGetUserSessionsStatistics,
