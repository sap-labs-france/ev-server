    ...
    switch (httpVerb) {
      ...
      case 'GET':
        ...
        this.registerJsonActionsPaths({
          ...
          ChargingStationTransactionsStatistics: StatisticService.handleGetChargingStationTransactionsStatistics,
          ChargingStationPricingStatistics: StatisticService.handleGetChargingStationPricingStatistics,
          ...
          UserTransactionsStatistics: StatisticService.handleGetUserTransactionsStatistics,
