import { HttpBillingInvoiceRequest, HttpBillingInvoicesRequest, HttpDeletePaymentMethod, HttpPayInvoice, HttpPaymentMethods, HttpSetupPaymentMethod } from '../../../../types/requests/HttpBillingRequest';
...
export default class BillingValidator extends SchemaValidator {
  ...
  public validateBillingPayInvoiceReq(data: Record<string, unknown>): HttpPayInvoice {
