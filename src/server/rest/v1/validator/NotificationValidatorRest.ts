import {
  HttpEndUserReportErrorGetRequest,
  HttpNotificationGetRequest,
} from '../../../../types/requests/HttpNotificationRequest';
...
export default class NotificationValidatorRest extends SchemaValidator {
  ...
  private notificationsGet: Schema = JSON.parse(
    fs.readFileSync(
      `${global.appRoot}/assets/server/rest/v1/schemas/notification/notifications-get.json`,
      'utf8'
    )
  );
  private notificationsEndUserErrorReport: Schema = JSON.parse(
    fs.readFileSync(
      `${global.appRoot}/assets/server/rest/v1/schemas/notification/notifications-end-user-error-report.json`,
      'utf8'
    )
  );
  ...
  public validateEndUserErrorReportReq(
