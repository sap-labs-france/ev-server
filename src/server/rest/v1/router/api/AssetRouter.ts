...
export default class AssetRouter {
  ...
  private buildRouteCreateAssetConsumption(): void {
    this.router.post(
      `/${RESTServerRoute.REST_ASSET_CONSUMPTIONS}`,
      (req: Request, res: Response, next: NextFunction) => {
        req.query.assetID = req.params.id;
        void RouterUtils.handleRestServerAction(
          AssetService.handleCreateAssetConsumption.bind(this),
          ServerAction.ASSET_CONSUMPTION,
          req,
          res,
          next
        );
  ...
  private buildRouteCreateAsset(): void {
    this.router.post(
      `/${RESTServerRoute.REST_ASSETS}`,
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
          AssetService.handleCreateAsset.bind(this),
          ServerAction.ASSET_CREATE,
          req,
          res,
          next
        );
  ...
  private buildRouteGetAssets(): void {
    this.router.get(
      ...
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
          AssetService.handleGetAssets.bind(this),
          ServerAction.ASSETS,
          req,
          res,
          next
  ...
  private buildRouteGetAsset(): void {
    this.router.get(
      `/${RESTServerRoute.REST_ASSET}`,
      (req: Request, res: Response, next: NextFunction) => {
        req.query.ID = req.params.id;
        void RouterUtils.handleRestServerAction(
          AssetService.handleGetAsset.bind(this),
          ServerAction.ASSET,
          req,
          res,
          next
  ...
  private buildRouteGetAssetsInError(): void {
    this.router.get(
      `/${RESTServerRoute.REST_ASSETS_IN_ERROR}`,
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
          AssetService.handleGetAssetsInError.bind(this),
          ServerAction.ASSETS_IN_ERROR,
          req,
          res,
          next
        );
  ...
  private buildRouteCheckAssetConnection(): void {
    this.router.get(
      ...
      (req: Request, res: Response, next: NextFunction) => {
        req.query.ID = req.params.id;
        void RouterUtils.handleRestServerAction(
          AssetService.handleCheckAssetConnection.bind(this),
          ServerAction.CHECK_ASSET_CONNECTION,
          req,
          res,
          next
        );
  ...
  private buildRouteGetAssetLastConsumption(): void {
    this.router.get(
      `/${RESTServerRoute.REST_ASSET_RETRIEVE_CONSUMPTION}`,
      (req: Request, res: Response, next: NextFunction) => {
        req.query.ID = req.params.id;
        void RouterUtils.handleRestServerAction(
  ...
  private buildRouteGetAssetConsumptions(): void {
    this.router.get(
      ...
      (req: Request, res: Response, next: NextFunction) => {
        req.query.AssetID = req.params.id;
        void RouterUtils.handleRestServerAction(
          AssetService.handleGetAssetConsumption.bind(this),
          ServerAction.ASSET_CONSUMPTION,
          req,
          res,
          next
  ...
  private buildRouteUpdateAsset(): void {
    this.router.put(
      ...
      (req: Request, res: Response, next: NextFunction) => {
        ...
        void RouterUtils.handleRestServerAction(
          AssetService.handleUpdateAsset.bind(this),
          ServerAction.ASSET_UPDATE,
          req,
          res,
          next
        );
  ...
  private buildRouteDeleteAsset(): void {
    this.router.delete(
      ...
      (req: Request, res: Response, next: NextFunction) => {
        req.query.ID = req.params.id;
        void RouterUtils.handleRestServerAction(
          AssetService.handleDeleteAsset.bind(this),
          ServerAction.ASSET_DELETE,
          req,
          res,
          next
        );
