...
export default class RegistrationTokenRouter {
  ...
  private buildRouteUpdateRegistrationTokens(): void {
    this.router.put(`/${ServerRoute.REST_REGISTRATION_TOKEN}`, async (req: Request, res: Response, next: NextFunction) => {
  ...
  private buildRouteDeleteRegistrationTokens(): void {
    this.router.delete(`/${ServerRoute.REST_REGISTRATION_TOKEN}`, async (req: Request, res: Response, next: NextFunction) => {
  ...
  private buildRouteRevokeRegistrationTokens(): void {
    this.router.put(`/${ServerRoute.REST_REGISTRATION_TOKEN_REVOKE}`, async (req: Request, res: Response, next: NextFunction) => {
      req.query.ID = req.params.id;
