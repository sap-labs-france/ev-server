...
export default class SiteAreaRouter {
  ...
  private buildRouteSiteAreas(): void {
    this.router.get(
      `/${RESTServerRoute.REST_SITE_AREAS}`,
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
          SiteAreaService.handleGetSiteAreas.bind(this),
          ServerAction.SITE_AREAS,
          req,
          res,
          next
        );
  ...
  private buildRouteSiteArea(): void {
    this.router.get(
      ...
      (req: Request, res: Response, next: NextFunction) => {
        ...
        void RouterUtils.handleRestServerAction(
          SiteAreaService.handleGetSiteArea.bind(this),
          ServerAction.SITE_AREA,
          req,
          res,
          next
        );
  ...
  private buildRouteCreateSiteArea(): void {
    this.router.post(
      ...
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
          SiteAreaService.handleCreateSiteArea.bind(this),
          ServerAction.SITE_AREA_CREATE,
          req,
          res,
          next
        );
  ...
  private buildRouteUpdateSiteArea(): void {
    this.router.put(
      ...
      (req: Request, res: Response, next: NextFunction) => {
        ...
        void RouterUtils.handleRestServerAction(
          SiteAreaService.handleUpdateSiteArea.bind(this),
          ServerAction.SITE_AREA_UPDATE,
          req,
          res,
          next
        );
  ...
  private buildRouteDeleteSiteArea(): void {
    this.router.delete(
      ...
      (req: Request, res: Response, next: NextFunction) => {
        req.query.ID = req.params.id;
        void RouterUtils.handleRestServerAction(
          SiteAreaService.handleDeleteSiteArea.bind(this),
          ServerAction.SITE_AREA_DELETE,
          req,
          res,
          next
        );
  ...
  private buildRouteAssignChargingStationsToSiteArea(): void {
    this.router.put(
      `/${RESTServerRoute.REST_SITE_AREA_ASSIGN_CHARGING_STATIONS}`,
      (req: Request, res: Response, next: NextFunction) => {
  ...
  private buildRouteRemoveChargingStationsFromSiteArea(): void {
    this.router.put(
      `/${RESTServerRoute.REST_SITE_AREA_REMOVE_CHARGING_STATIONS}`,
      (req: Request, res: Response, next: NextFunction) => {
        req.body.siteAreaID = req.params.id;
        void RouterUtils.handleRestServerAction(
          SiteAreaService.handleAssignChargingStationsToSiteArea.bind(this),
  ...
  private buildRouteRemoveAssetsToSiteArea(): void {
    this.router.put(
      `/${RESTServerRoute.REST_SITE_AREA_REMOVE_ASSETS}`,
      (req: Request, res: Response, next: NextFunction) => {
        req.body.siteAreaID = req.params.id;
        void RouterUtils.handleRestServerAction(
          SiteAreaService.handleAssignAssetsToSiteArea.bind(this),
