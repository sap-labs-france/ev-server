...
export default class UserRouter {
  ...
  private buildRouteUsers(): void {
    this.router.get(
      `/${RESTServerRoute.REST_USERS}`,
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
          UserService.handleGetUsers.bind(this),
          ServerAction.USERS,
          req,
          res,
          next
  ...
  private buildRouteUser(): void {
    this.router.get(
      ...
      (req: Request, res: Response, next: NextFunction) => {
        ...
        void RouterUtils.handleRestServerAction(
          UserService.handleGetUser.bind(this),
          ServerAction.USER,
          req,
          res,
          next
  ...
  private buildRouteCreateUser(): void {
    this.router.post(
      ...
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
          UserService.handleCreateUser.bind(this),
  ...
  private buildRouteUpdateUser(): void {
    this.router.put(
      ...
      (req: Request, res: Response, next: NextFunction) => {
        ...
        void RouterUtils.handleRestServerAction(
          UserService.handleUpdateUser.bind(this),
  ...
  private buildRouteDeleteUser(): void {
    this.router.delete(
      ...
      (req: Request, res: Response, next: NextFunction) => {
        req.query.ID = req.params.id;
        void RouterUtils.handleRestServerAction(
          UserService.handleDeleteUser.bind(this),
          ServerAction.USER_DELETE,
          req,
          res,
          next
        );
  ...
  private buildRouteUserDefaultCarTag(): void {
    this.router.get(
      `/${RESTServerRoute.REST_USER_DEFAULT_TAG_CAR}`,
      (req: Request, res: Response, next: NextFunction) => {
        ...
        void RouterUtils.handleRestServerAction(
          UserService.handleGetUserDefaultTagCar.bind(this),
          ServerAction.USER_DEFAULT_TAG_CAR,
          req,
          res,
          next
        );
  ...
  private buildRouteUserSessionContext(): void {
    this.router.get(
      `/${RESTServerRoute.REST_USER_SESSION_CONTEXT}`,
      (req: Request, res: Response, next: NextFunction) => {
        req.query.UserID = req.params.id;
        void RouterUtils.handleRestServerAction(
          UserService.handleGetUserSessionContext.bind(this),
          ServerAction.USER_SESSION_CONTEXT,
          req,
          res,
          next
        );
  ...
  private buildRouteUserGetSites(): void {
    this.router.get(
      `/${RESTServerRoute.REST_USER_SITES}`,
      (req: Request, res: Response, next: NextFunction) => {
        req.query.UserID = req.params.id;
        void RouterUtils.handleRestServerAction(
          UserService.handleGetSites.bind(this),
          ServerAction.USER_SITES,
          req,
          res,
          next
        );
  ...
  private buildRouteUserSiteAssign(): void {
    this.router.post(
      ...
      (req: Request, res: Response, next: NextFunction) => {
        ...
        void RouterUtils.handleRestServerAction(
          UserService.handleAssignSitesToUser.bind(this),
          ServerAction.ADD_SITES_TO_USER,
          req,
          res,
          next
        );
  ...
  private buildRouteUserSiteUnassign(): void {
    this.router.put(
      ...
      (req: Request, res: Response, next: NextFunction) => {
        ...
        void RouterUtils.handleRestServerAction(
          UserService.handleAssignSitesToUser.bind(this),
          ServerAction.REMOVE_SITES_FROM_USER,
          req,
          res,
          next
        );
  ...
  private buildRouteUserUpdateMobileToken(): void {
    this.router.put(
      `/${RESTServerRoute.REST_USER_UPDATE_MOBILE_TOKEN}`,
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
          UserService.handleUpdateUserMobileData.bind(this),
          ServerAction.USER_UPDATE_MOBILE_DATA,
          req,
          res,
          next
        );
  ...
  private buildRouteUserUpdateMobileData(): void {
    this.router.put(
      `/${RESTServerRoute.REST_USER_UPDATE_MOBILE_DATA}`,
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
          UserService.handleUpdateUserMobileData.bind(this),
          ServerAction.USER_UPDATE_MOBILE_DATA,
  ...
  private buildRouteUserGetImage(): void {
    this.router.get(
      `/${RESTServerRoute.REST_USER_IMAGE}`,
      (req: Request, res: Response, next: NextFunction) => {
        req.query.ID = req.params.id;
        void RouterUtils.handleRestServerAction(
          UserService.handleGetUserImage.bind(this),
          ServerAction.USER_IMAGE,
          req,
          res,
          next
        );
  ...
  private buildRouteUsersInError(): void {
    this.router.get(
      `/${RESTServerRoute.REST_USERS_IN_ERROR}`,
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
          UserService.handleGetUsersInError.bind(this),
          ServerAction.USERS_IN_ERROR,
          req,
          res,
          next
        );
  ...
  private buildRouteUserImport(): void {
    this.router.post(
      ...
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
          UserService.handleImportUsers.bind(this),
          ServerAction.USERS_IMPORT,
          req,
          res,
          next
        );
  ...
  private buildRouteUserExport(): void {
    this.router.get(
      `/${RESTServerRoute.REST_USERS_EXPORT}`,
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
          UserService.handleExportUsers.bind(this),
          ServerAction.USERS_EXPORT,
          req,
          res,
          next
        );
