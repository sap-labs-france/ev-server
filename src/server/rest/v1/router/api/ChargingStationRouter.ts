...
export default class ChargingStationRouter {
  ...
  private buildRouteChargingStation(): void {
    this.router.get(
      `/${RESTServerRoute.REST_CHARGING_STATION}`,
      (req: Request, res: Response, next: NextFunction) => {
        req.query.ID = req.params.id;
        void RouterUtils.handleRestServerAction(
          ChargingStationService.handleGetChargingStation.bind(this),
          ServerAction.CHARGING_STATION,
          req,
          res,
          next
        );
  ...
  private buildRouteChargingStationDelete(): void {
    this.router.delete(
      `/${RESTServerRoute.REST_CHARGING_STATIONS}/:id`,
      (req: Request, res: Response, next: NextFunction) => {
        req.query.ID = req.params.id;
        void RouterUtils.handleRestServerAction(
          ChargingStationService.handleDeleteChargingStation.bind(this),
          ServerAction.CHARGING_STATION_DELETE,
          req,
          res,
          next
        );
  ...
  private buildRouteChargingStationReset(): void {
    this.router.put(
      `/${RESTServerRoute.REST_CHARGING_STATIONS_RESET}`,
      (req: Request, res: Response, next: NextFunction) => {
        req.body.chargingStationID = req.params.id;
        void RouterUtils.handleRestServerAction(
          ChargingStationService.handleOcppAction.bind(this),
  ...
  private buildRouteChargingStationClearCache(): void {
    this.router.put(
      `/${RESTServerRoute.REST_CHARGING_STATIONS_CACHE_CLEAR}`,
      (req: Request, res: Response, next: NextFunction) => {
        req.body.chargingStationID = req.params.id;
        void RouterUtils.handleRestServerAction(
          ChargingStationService.handleOcppAction.bind(this),
  ...
  private buildRouteChargingStationTriggerDataTransfer(): void {
    this.router.put(
      `/${RESTServerRoute.REST_CHARGING_STATIONS_TRIGGER_DATA_TRANSFER}`,
      (req: Request, res: Response, next: NextFunction) => {
        req.body.chargingStationID = req.params.id;
        void RouterUtils.handleRestServerAction(
          ChargingStationService.handleOcppAction.bind(this),
          ServerAction.CHARGING_STATION_TRIGGER_DATA_TRANSFER,
          req,
          res,
          next
        );
  ...
  private buildRouteChargingStationRetrieveConfiguration(): void {
    this.router.put(
      `/${RESTServerRoute.REST_CHARGING_STATIONS_RETRIEVE_CONFIGURATION}`,
      (req: Request, res: Response, next: NextFunction) => {
        req.body.chargingStationID = req.params.id;
        void RouterUtils.handleRestServerAction(
          ChargingStationService.handleOcppAction.bind(this),
  ...
  private buildRouteChargingStationChangeConfiguration(): void {
    this.router.put(
      `/${RESTServerRoute.REST_CHARGING_STATIONS_CHANGE_CONFIGURATION}`,
      (req: Request, res: Response, next: NextFunction) => {
        req.body.chargingStationID = req.params.id;
        void RouterUtils.handleRestServerAction(
          ChargingStationService.handleOcppAction.bind(this),
  ...
  private buildRouteChargingStationRemoteStart(): void {
    this.router.put(
      `/${RESTServerRoute.REST_CHARGING_STATIONS_REMOTE_START}`,
      (req: Request, res: Response, next: NextFunction) => {
        req.body.chargingStationID = req.params.id;
        void RouterUtils.handleRestServerAction(
          ChargingStationService.handleOcppAction.bind(this),
  ...
  private buildRouteChargingStationRemoteStop(): void {
    this.router.put(
      `/${RESTServerRoute.REST_CHARGING_STATIONS_REMOTE_STOP}`,
      (req: Request, res: Response, next: NextFunction) => {
        req.body.chargingStationID = req.params.id;
        void RouterUtils.handleRestServerAction(
          ChargingStationService.handleOcppAction.bind(this),
  ...
  private buildRouteChargingStationUnlockConnector(): void {
    this.router.put(
      `/${RESTServerRoute.REST_CHARGING_STATIONS_UNLOCK_CONNECTOR}`,
      (req: Request, res: Response, next: NextFunction) => {
        req.body.chargingStationID = req.params.id;
  ...
  private buildRouteChargingStationGetCompositeSchedule(): void {
    this.router.put(
      `/${RESTServerRoute.REST_CHARGING_STATIONS_GET_COMPOSITE_SCHEDULE}`,
      (req: Request, res: Response, next: NextFunction) => {
        req.body.chargingStationID = req.params.id;
        void RouterUtils.handleRestServerAction(
          ChargingStationService.handleOcppAction.bind(this),
  ...
  private buildRouteChargingStationGetDiagnostics(): void {
    this.router.put(
      `/${RESTServerRoute.REST_CHARGING_STATIONS_GET_DIAGNOSTICS}`,
      (req: Request, res: Response, next: NextFunction) => {
        req.body.chargingStationID = req.params.id;
        void RouterUtils.handleRestServerAction(
          ChargingStationService.handleOcppAction.bind(this),
  ...
  private buildRouteChargingStationUpdateFirmware(): void {
    this.router.put(
      `/${RESTServerRoute.REST_CHARGING_STATIONS_FIRMWARE_UPDATE}`,
      (req: Request, res: Response, next: NextFunction) => {
        req.body.chargingStationID = req.params.id;
        void RouterUtils.handleRestServerAction(
          ChargingStationService.handleOcppAction.bind(this),
  ...
  private buildRouteChargingStationChangeAvailability(): void {
    this.router.put(
      `/${RESTServerRoute.REST_CHARGING_STATIONS_CHANGE_AVAILABILITY}`,
      (req: Request, res: Response, next: NextFunction) => {
        req.body.chargingStationID = req.params.id;
        void RouterUtils.handleRestServerAction(
          ChargingStationService.handleOcppAction.bind(this),
  ...
  private buildRouteChargingStationGenerateQRCode(): void {
    this.router.get(
      ...
      (req: Request, res: Response, next: NextFunction) => {
        ...
        void RouterUtils.handleRestServerAction(
          ChargingStationService.handleGenerateQrCodeForConnector.bind(this),
          ServerAction.GENERATE_QR_CODE_FOR_CONNECTOR,
          req,
          res,
          next
        );
  ...
  private buildRouteChargingStationDownloadQRCode(): void {
    this.router.get(
      `/${RESTServerRoute.REST_CHARGING_STATIONS_QRCODE_DOWNLOAD}`,
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
          ChargingStationService.handleDownloadQrCodesPdf.bind(this),
          ServerAction.CHARGING_STATION_DOWNLOAD_QR_CODE_PDF,
          req,
          res,
          next
        );
  ...
  private buildRouteChargingStationGetOCPPParameters(): void {
    this.router.get(
      ...
      (req: Request, res: Response, next: NextFunction) => {
        req.query.ChargingStationID = req.params.id;
        void RouterUtils.handleRestServerAction(
          ChargingStationService.handleGetChargingStationOcppParameters.bind(this),
          ServerAction.CHARGING_STATIONS_OCPP_PARAMETERS,
          req,
          res,
          next
        );
  ...
  private buildRouteChargingStationRequestOCPPParameters(): void {
    this.router.post(
      `/${RESTServerRoute.REST_CHARGING_STATIONS_REQUEST_OCPP_PARAMETERS}`,
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
  ...
  private buildRouteChargingStationExportOCPPParameters(): void {
    this.router.get(
      `/${RESTServerRoute.REST_CHARGING_STATIONS_EXPORT_OCPP_PARAMETERS}`,
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
          ChargingStationService.handleExportChargingStationsOCPPParams.bind(this),
          ServerAction.CHARGING_STATIONS_OCPP_PARAMS_EXPORT,
          req,
          res,
          next
        );
  ...
  private buildRouteChargingStationUpdateParameters(): void {
    this.router.put(
      `/${RESTServerRoute.REST_CHARGING_STATIONS_UPDATE_PARAMETERS}`,
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
          ChargingStationService.handleUpdateChargingStationParams.bind(this),
          ServerAction.CHARGING_STATION_UPDATE_PARAMS,
          req,
          res,
          next
        );
  ...
  private buildRouteChargingStationLimitPower(): void {
    this.router.put(
      `/${RESTServerRoute.REST_CHARGING_STATIONS_POWER_LIMIT}`,
      (req: Request, res: Response, next: NextFunction) => {
        req.body.chargingStationID = req.params.id;
        void RouterUtils.handleRestServerAction(
          ChargingStationService.handleChargingStationLimitPower.bind(this),
          ServerAction.CHARGING_STATION_LIMIT_POWER,
          req,
          res,
          next
        );
  ...
  private buildRouteChargingStationTransactions(): void {
    this.router.get(
      `/${RESTServerRoute.REST_CHARGING_STATIONS_TRANSACTIONS}`,
      (req: Request, res: Response, next: NextFunction) => {
        req.query.ChargingStationID = req.params.id;
        void RouterUtils.handleRestServerAction(
  ...
  private buildRouteChargingStationsInError(): void {
    this.router.get(
      ...
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
          ChargingStationService.handleGetChargingStationsInError.bind(this),
          ServerAction.CHARGING_STATIONS_IN_ERROR,
          req,
          res,
          next
        );
  ...
  private buildRouteChargingStationsExport(): void {
    this.router.get(
      `/${RESTServerRoute.REST_CHARGING_STATIONS_EXPORT}`,
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
          ChargingStationService.handleExportChargingStations.bind(this),
          ServerAction.CHARGING_STATIONS_EXPORT,
          req,
          res,
          next
        );
  ...
  private buildRouteChargingStationCheckSmartCharging(): void {
    this.router.get(
      `/${RESTServerRoute.REST_CHARGING_STATION_CHECK_SMART_CHARGING_CONNECTION}`,
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
          ChargingStationService.handleCheckSmartChargingConnection.bind(this),
          ServerAction.CHECK_SMART_CHARGING_CONNECTION,
          req,
          res,
          next
        );
  ...
  private buildRouteChargingStationTriggerSmartCharging(): void {
    this.router.get(
      `/${RESTServerRoute.REST_CHARGING_STATION_TRIGGER_SMART_CHARGING}`,
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
          ChargingStationService.handleTriggerSmartCharging.bind(this),
          ServerAction.TRIGGER_SMART_CHARGING,
          req,
          res,
          next
        );
  ...
  private buildRouteChargingStationGetChargingProfiles(): void {
    this.router.get(
      `/${RESTServerRoute.REST_CHARGING_PROFILES}`,
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
          ChargingStationService.handleGetChargingProfiles.bind(this),
  ...
  private buildRouteChargingStationCreateChargingProfile(): void {
    this.router.post(
      ...
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
          ChargingStationService.handleCreateChargingProfile.bind(this),
          ServerAction.CHARGING_PROFILE_CREATE,
          req,
          res,
          next
        );
  ...
  private buildRouteChargingStationUpdateChargingProfile(): void {
    this.router.put(
      `/${RESTServerRoute.REST_CHARGING_PROFILE}`,
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
          ChargingStationService.handleUpdateChargingProfile.bind(this),
  ...
  private buildRouteChargingStationDeleteChargingProfile(): void {
    this.router.delete(
      ...
      (req: Request, res: Response, next: NextFunction) => {
        req.query.ID = req.params.id;
        void RouterUtils.handleRestServerAction(
          ChargingStationService.handleDeleteChargingProfile.bind(this),
  ...
  private buildRouteChargingStationGetBootNotifications(): void {
    this.router.get(
      `/${RESTServerRoute.REST_CHARGING_STATIONS_BOOT_NOTIFICATIONS}`,
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
          ChargingStationService.handleGetBootNotifications.bind(this),
          ServerAction.BOOT_NOTIFICATIONS,
          req,
          res,
          next
        );
  ...
  private buildRouteChargingStationGetStatusNotifications(): void {
    this.router.get(
      ...
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
          ChargingStationService.handleGetStatusNotifications.bind(this),
          ServerAction.STATUS_NOTIFICATIONS,
          req,
          res,
          next
        );
  ...
  private buildRouteChargingStationReserveNow(): void {
    this.router.put(
      ...
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
          ChargingStationService.handleReserveNow.bind(this),
  ...
  private buildRouteChargingStationCancelReservation(): void {
    this.router.put(
      `/${RESTServerRoute.REST_CHARGING_STATIONS_CANCEL_RESERVATION}`,
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
