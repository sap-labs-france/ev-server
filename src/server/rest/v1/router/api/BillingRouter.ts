...
export default class BillingRouter {
  ...
  private buildRouteBillingSetting(): void {
    this.router.get(
      `/${RESTServerRoute.REST_BILLING_SETTING}`,
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
          BillingService.handleGetBillingSetting.bind(this),
          ServerAction.SETTINGS,
          req,
          res,
          next
        );
  ...
  private buildRouteUpdateBillingSetting(): void {
    this.router.put(
      ...
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
          BillingService.handleUpdateBillingSetting.bind(this),
          ServerAction.SETTINGS,
          req,
          res,
          next
  ...
  private buildRouteCheckBillingConnection(): void {
    this.router.post(
      `/${RESTServerRoute.REST_BILLING_CHECK}`,
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
  ...
  private buildRouteClearTestData(): void {
    this.router.post(
      `/${RESTServerRoute.REST_BILLING_CLEAR_TEST_DATA}`,
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
          BillingService.handleClearBillingTestData.bind(this),
          ServerAction.SETTINGS,
          req,
          res,
          next
  ...
  private buildRouteBillingPaymentMethods(): void {
    this.router.get(
      `/${RESTServerRoute.REST_BILLING_PAYMENT_METHODS}`,
      (req: Request, res: Response, next: NextFunction) => {
  ...
  private buildRouteBillingDeletePaymentMethod(): void {
    ...
    this.router.delete(
      `/${RESTServerRoute.REST_BILLING_PAYMENT_METHOD}`,
      (req: Request, res: Response, next: NextFunction) => {
  ...
  private buildRouteForceSynchronizeUser(): void {
    this.router.patch(
      `/${RESTServerRoute.REST_BILLING_USER_SYNCHRONIZE}`,
      (req: Request, res: Response, next: NextFunction) => {
  ...
  private buildRouteBillingPaymentMethodSetup(): void {
    this.router.post(
      `/${RESTServerRoute.REST_BILLING_PAYMENT_METHOD_SETUP}`,
      (req: Request, res: Response, next: NextFunction) => {
  ...
  private buildRouteBillingPaymentMethodAttach(): void {
    this.router.post(
      `/${RESTServerRoute.REST_BILLING_PAYMENT_METHOD_ATTACH}`,
      (req: Request, res: Response, next: NextFunction) => {
  ...
  private buildRouteBillingPaymentMethodDetach(): void {
    this.router.post(
      `/${RESTServerRoute.REST_BILLING_PAYMENT_METHOD_DETACH}`,
      (req: Request, res: Response, next: NextFunction) => {
  ...
  private buildRouteBillingInvoices(): void {
    this.router.get(
      `/${RESTServerRoute.REST_BILLING_INVOICES}`,
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
          BillingService.handleGetInvoices.bind(this),
          ServerAction.BILLING_INVOICES,
          req,
          res,
          next
        );
  ...
  private buildRouteBillingInvoice(): void {
    this.router.get(
      `/${RESTServerRoute.REST_BILLING_INVOICE}`,
      (req: Request, res: Response, next: NextFunction) => {
        // GET {{base_url}}/v1/api/invoices/606193168f22ac7f02223c8c
        req.query.ID = req.params.invoiceID;
        void RouterUtils.handleRestServerAction(
          BillingService.handleGetInvoice.bind(this),
          ServerAction.BILLING_INVOICE,
          req,
          res,
          next
        );
  ...
  private buildRouteBillingInvoiceDownload(): void {
    this.router.get(
      `/${RESTServerRoute.REST_BILLING_DOWNLOAD_INVOICE}`,
      (req: Request, res: Response, next: NextFunction) => {
        // GET {{base_url}}/v1/api/invoices/606193168f22ac7f02223c8c/download
        req.query.ID = req.params.invoiceID;
        void RouterUtils.handleRestServerAction(
          BillingService.handleDownloadInvoice.bind(this),
          ServerAction.BILLING_DOWNLOAD_INVOICE,
          req,
          res,
          next
        );
  ...
  private buildRouteBillingTransferDownload(): void {
    this.router.get(
      `/${RESTServerRoute.REST_BILLING_TRANSFER_DOWNLOAD_INVOICE}`,
      (req: Request, res: Response, next: NextFunction) => {
  ...
  private buildRouteBillingGetTaxes(): void {
    this.router.get(
      `/${RESTServerRoute.REST_BILLING_TAXES}`,
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
          BillingService.handleGetBillingTaxes.bind(this),
  ...
  private buildRouteBillingCreateAccount(): void {
    this.router.post(
      `/${RESTServerRoute.REST_BILLING_ACCOUNTS}`,
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
          BillingService.handleCreateAccount.bind(this),
  ...
  private buildRouteBillingGetAccounts(): void {
    this.router.get(
      ...
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
          BillingService.handleBillingGetAccounts.bind(this),
          ServerAction.BILLING_ACCOUNTS,
          req,
          res,
          next
        );
  ...
  private buildRouteBillingGetAccount(): void {
    this.router.get(
      `/${RESTServerRoute.REST_BILLING_ACCOUNT}`,
      (req: Request, res: Response, next: NextFunction) => {
        req.params.ID = req.params.id;
        void RouterUtils.handleRestServerAction(
          BillingService.handleBillingGetAccount.bind(this),
          ServerAction.BILLING_ACCOUNT,
          req,
          res,
          next
        );
  ...
  private buildRouteBillingSendAccountOnboarding(): void {
    this.router.patch(
      `/${RESTServerRoute.REST_BILLING_ACCOUNT_ONBOARD}`,
      (req: Request, res: Response, next: NextFunction) => {
        req.params.ID = req.params.id;
        void RouterUtils.handleRestServerAction(
          BillingService.handleOnboardAccount.bind(this),
          ServerAction.BILLING_ACCOUNT_ONBOARD,
          req,
          res,
          next
        );
  ...
  private buildRouteBillingGetTransfers(): void {
    this.router.get(
      ...
      (req: Request, res: Response, next: NextFunction) => {
        void RouterUtils.handleRestServerAction(
          BillingService.handleBillingGetTransfers.bind(this),
          ServerAction.BILLING_TRANSFERS,
          req,
          res,
          next
        );
  ...
  private buildRouteBillingGetTransfer(): void {
    this.router.get(
      `/${RESTServerRoute.REST_BILLING_TRANSFER}`,
      (req: Request, res: Response, next: NextFunction) => {
        req.query.ID = req.params.id;
        void RouterUtils.handleRestServerAction(
          BillingService.handleGetTransfer.bind(this),
          ServerAction.BILLING_TRANSFER,
          req,
          res,
          next
        );
  ...
  private buildRouteBillingFinalizeTransfer(): void {
    this.router.patch(
      `/${RESTServerRoute.REST_BILLING_TRANSFER_FINALIZE}`,
      (req: Request, res: Response, next: NextFunction) => {
        req.params.ID = req.params.id;
        void RouterUtils.handleRestServerAction(
          BillingService.handleFinalizeTransfer.bind(this),
          ServerAction.BILLING_TRANSFER_FINALIZE,
          req,
          res,
          next
        );
  ...
  private buildRouteBillingSendTransfer(): void {
    this.router.patch(
      `/${RESTServerRoute.REST_BILLING_TRANSFER_SEND}`,
      (req: Request, res: Response, next: NextFunction) => {
        req.params.ID = req.params.id;
        void RouterUtils.handleRestServerAction(
          BillingService.handleSendTransfer.bind(this),
          ServerAction.BILLING_TRANSFER_SEND,
          req,
          res,
          next
        );
