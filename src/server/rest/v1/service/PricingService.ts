...
export default class PricingService {
  public static async handleResolvePricingModel(
    action: ServerAction,
    req: Request,
    res: Response,
    next: NextFunction
    ...
    UtilsService.assertComponentIsActiveFromToken(
      ...
      MODULE_NAME,
      'handleResolvePricingModel'
    );
    // Filter
    const filteredRequest = PricingValidatorRest.getInstance().validatePricingModelResolve(
      req.query
    );
    ...
    if (pricingImpl) {
      ...
      pricingContext = PricingHelper.buildUserPricingContext(
        req.tenant,
      ...
      const pricingModel: ResolvedPricingModel = await pricingImpl.resolvePricingContext(
        pricingContext
      );
  ...
  public static async handleGetPricingDefinition(
    action: ServerAction,
    req: Request,
    res: Response,
    next: NextFunction
    ...
    UtilsService.assertComponentIsActiveFromToken(
      ...
      Entity.PRICING_DEFINITION,
      MODULE_NAME,
      'handleGetPricingDefinition'
    );
    // Filter
    const filteredRequest = PricingValidatorRest.getInstance().validatePricingDefinitionGet(
      req.query
    );
  ...
  public static async handleGetPricingDefinitions(
    action: ServerAction,
    req: Request,
    res: Response,
    next: NextFunction
    ...
    UtilsService.assertComponentIsActiveFromToken(
      ...
      Entity.PRICING_DEFINITION,
      MODULE_NAME,
      'handleGetPricingDefinitions'
    );
    // Filter
    const filteredRequest = PricingValidatorRest.getInstance().validatePricingDefinitionsGet(
      req.query
    );
    // Check dynamic auth
    ...
    const pricingDefinitions = (await PricingStorage.getPricingDefinitions(
      req.tenant,
      {
    ...
    if (filteredRequest.WithAuth) {
      await AuthorizationService.addPricingDefinitionsAuthorizations(
        req.tenant,
        req.user,
        pricingDefinitions,
        authorizations
    ...
    pricingDefinitions.canCreate = await PricingService.alterCanCreate(
      req,
      action,
      filteredRequest.EntityType,
      filteredRequest.EntityID,
      pricingDefinitions.canCreate
    );
    res.json(pricingDefinitions);
    next();
  }

  public static async handleCreatePricingDefinition(
    action: ServerAction,
    req: Request,
    res: Response,
    next: NextFunction
    ...
    UtilsService.assertComponentIsActiveFromToken(
      ...
      Entity.PRICING_DEFINITION,
      MODULE_NAME,
      'handleCreatePricingDefinition'
    );
    // Filter
    const filteredRequest = PricingValidatorRest.getInstance().validatePricingDefinitionCreate(
      req.body
    );
    ...
    const siteID = await PricingService.checkAuthorizationAndGetSiteID(
      req,
      action,
      filteredRequest.entityType,
      filteredRequest.entityID
    ...
    // Save
    newPricingDefinition.id = await PricingStorage.savePricingDefinition(
      req.tenant,
  ...
  public static async handleUpdatePricingDefinition(
    action: ServerAction,
    req: Request,
    res: Response,
    next: NextFunction
    ...
    UtilsService.assertComponentIsActiveFromToken(
      ...
      Entity.PRICING_DEFINITION,
      MODULE_NAME,
      'handleUpdatePricingDefinition'
    );
    // Filter
    const filteredRequest = PricingValidatorRest.getInstance().validatePricingDefinitionUpdate(
      req.body
    );
    // Check Pricing Definition
    UtilsService.checkIfPricingDefinitionValid(filteredRequest, req);
    ...
    await Logging.logInfo({
      ...
      user: req.user,
      module: MODULE_NAME,
      method: 'handleUpdatePricingDefinition',
  ...
  public static async handleDeletePricingDefinition(
    action: ServerAction,
    req: Request,
    res: Response,
    next: NextFunction
    ...
    UtilsService.assertComponentIsActiveFromToken(
      ...
      Entity.PRICING_DEFINITION,
      MODULE_NAME,
      'handleDeletePricingDefinition'
    );
    // Filter
    const pricingDefinitionID = PricingValidatorRest.getInstance().validatePricingDefinitionDelete(
      req.query
    ).ID;
    // Check and Get Pricing
    const pricingDefinition = await UtilsService.checkAndGetPricingDefinitionAuthorization(
    ...
    const siteID = await PricingService.checkAuthorizationAndGetSiteID(
      req,
      action,
      pricingDefinition.entityType,
      pricingDefinition.entityID
    );
    // Check that the pricing definitions can be changed for that site
    if (siteID) {
      await UtilsService.checkAndGetSiteAuthorization(
    ...
    await Logging.logInfo({
      ...
      user: req.user,
      module: MODULE_NAME,
      method: 'handleDeletePricingDefinition',
  ...
  private static async checkAuthorizationAndGetSiteID(
    req: Request,
    action: ServerAction,
    ...
    switch (entityType) {
      ...
      case PricingEntity.SITE:
        site = await UtilsService.checkAndGetSiteAuthorization(
          req.tenant,
          req.user,
          entityID,
          Action.READ,
  ...
  private static async alterCanCreate(
    req: Request,
    action: ServerAction,
    entityType: PricingEntity,
    entityID: string,
