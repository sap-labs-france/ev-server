...
export default class ChargingStationTemplateService {
  public static async handleCreateChargingStationTemplate(
    action: ServerAction,
    req: Request,
    res: Response,
    next: NextFunction
    ...
    const filteredRequest =
      ChargingStationTemplateValidator.getInstance().validateChargingStationTemplateCreateReq(
        req.body
      );
    // Check dynamic auth
    ...
    newChargingStationTemplate.id =
      await ChargingStationTemplateStorage.saveChargingStationTemplate(newChargingStationTemplate);
    await Logging.logInfo({
      tenantID: req.tenant.id,
      user: req.user,
      module: MODULE_NAME,
      method: 'handleCreateChargingStationTemplate',
  ...
  public static async handleGetChargingStationTemplates(
    action: ServerAction,
    req: Request,
    res: Response,
    next: NextFunction
    ...
    // Filter
    const filteredRequest =
      ChargingStationTemplateValidator.getInstance().validateChargingStationTemplatesGetReq(
        req.query
      );
    // Check dynamic auth
    const authorizations =
      await AuthorizationService.checkAndGetChargingStationTemplatesAuthorizations(
        req.tenant,
        req.user,
        Action.LIST,
        filteredRequest
    ...
    if (filteredRequest.WithAuth) {
      await AuthorizationService.addChargingStationTemplatesAuthorizations(
        req.tenant,
        req.user,
        chargingStationTemplates as ChargingStationTemplateDataResult,
        authorizations
      );
    }
  ...
  public static async handleGetChargingStationTemplate(
    action: ServerAction,
    req: Request,
    res: Response,
    next: NextFunction
    ...
    // Filter
    const filteredRequest =
      ChargingStationTemplateValidator.getInstance().validateChargingStationTemplateGetReq(
        req.query
      );
    // Check and get templates
    const chargingStationTemplate =
      await UtilsService.checkAndGetChargingStationTemplateAuthorization(
        req.tenant,
        req.user,
        filteredRequest.ID,
        Action.READ,
  ...
  public static async handleDeleteChargingStationTemplate(
    action: ServerAction,
    req: Request,
    res: Response,
    next: NextFunction
    ...
    // Filter
    const chargingStationTemplateID =
      ChargingStationTemplateValidator.getInstance().validateChargingStationTemplateDeleteReq(
        req.query
      ).ID;
    ...
    // Delete
    await ChargingStationTemplateStorage.deleteChargingStationTemplate(
      req.tenant,
    ...
    await Logging.logInfo({
      ...
      user: req.user,
      module: MODULE_NAME,
      method: 'handleDeleteChargingStationTemplate',
  ...
  public static async handleUpdateChargingStationTemplate(
    action: ServerAction,
    req: Request,
    res: Response,
    next: NextFunction
    ...
    // Filter
    const filteredRequest =
      ChargingStationTemplateValidator.getInstance().validateChargingStationTemplateUpdateReq(
        req.body
      );
    // Check and get template by id
    const chargingStationTemplate =
    ...
    await Logging.logInfo({
      ...
      user: req.user,
      module: MODULE_NAME,
      method: 'handleUpdateChargingStationTemplate',
      message: `'${chargingStationTemplate.id}' has been updated successfully`,
      action,
      detailedMessages: { chargingStationtemplate: chargingStationTemplate },
    });
    res.json(Constants.REST_RESPONSE_SUCCESS);
    next();
  }
