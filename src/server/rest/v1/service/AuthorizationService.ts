...
import { AssetDataResult, BillingInvoiceDataResult, BillingPaymentMethodDataResult, BillingSubaccountsDataResult, CarCatalogDataResult, CarDataResult, ChargingProfileDataResult, ChargingStationDataResult, CompanyDataResult, DataResult, LogDataResult, PricingDefinitionDataResult, RegistrationTokenDataResult, SiteAreaDataResult, SiteDataResult, TagDataResult, UserDataResult } from '../../../../types/DataResult';
  ...
  public static async addChargingStationAuthorizations(tenant: Tenant, userToken: UserToken, chargingStation: ChargingStation,
    ...
    for (const connector of chargingStation.connectors) {
      ...
      connector.canStartTransaction = !chargingStation.inactive
        ...
        && await AuthorizationService.canPerformAuthorizationAction(tenant, userToken, Entity.CONNECTOR, Action.START_TRANSACTION, authorizationFilter,
          { chargingStationID: chargingStation.id, UserID: connector.user?.id, SiteID: chargingStation.siteID }, connector);
      // Unlock connector
