...
import {
  HttpBillingAccountGetRequest,
  HttpBillingAccountsGetRequest,
  HttpBillingInvoiceRequest,
  HttpBillingInvoicesRequest,
...
import {
  HttpChargingProfileRequest,
  HttpChargingProfilesGetRequest,
  HttpChargingStationGetRequest,
  HttpChargingStationsGetRequest,
} from '../../../../types/requests/HttpChargingStationRequest';
import {
  HttpChargingStationTemplateGetRequest,
  HttpChargingStationTemplatesGetRequest,
} from '../../../../types/requests/HttpChargingStationTemplateRequest';
import {
...
import {
  ...
  HttpTransactionGetRequest,
} from '../../../../types/requests/HttpTransactionRequest';
import {
  HttpUserGetRequest,
  HttpUserSitesAssignRequest,
...
export default class AuthorizationService {
  ...
  public static async checkAndGetSiteAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    filteredRequest: Partial<HttpSiteGetRequest>,
    authAction: Action,
    ...
    return AuthorizationService.checkAndGetEntityAuthorizations(
      ...
      userToken,
      filteredRequest,
      filteredRequest.ID ? { SiteID: filteredRequest.ID } : {},
      authAction,
      entityData
    );
  }

  public static async checkAndGetLoggingAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    filteredRequest: Partial<HttpLogGetRequest>,
    authAction: Action,
    entityData?: EntityData
  ): Promise<AuthorizationFilter> {
    return AuthorizationService.checkAndGetEntityAuthorizations(
      ...
      userToken,
      filteredRequest,
      filteredRequest.ID ? { LogID: filteredRequest.ID } : {},
      authAction,
      entityData
    );
  }

  public static async addSitesAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    sites: SiteDataResult,
    ...
    for (const site of sites.result) {
      await AuthorizationService.addSiteAuthorizations(
        tenant,
        userToken,
        site,
        authorizationFilter
  ...
  public static async addSiteAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    site: Site,
    authorizationFilter: AuthorizationFilter
    ...
    site.canMaintainPricingDefinitions = await AuthorizationService.canPerformAuthorizationAction(
      ...
      userToken,
      Entity.SITE,
      Action.MAINTAIN_PRICING_DEFINITIONS,
      authorizationFilter,
      { SiteID: site.id },
      site
    );
  ...
  public static async addLogsAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    logs: LogDataResult,
    authorizationFilter: AuthorizationFilter
  ...
  public static addLogAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    log: Log,
    authorizationFilter: AuthorizationFilter
  ...
  public static async checkAndGetSitesAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    filteredRequest: Partial<HttpSiteUsersRequest>,
  ...
  public static async checkAndGetLoggingsAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    filteredRequest: Partial<HttpSiteUsersRequest>,
    failsWithException = true
  ...
  public static async checkAndGetSiteUsersAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    filteredRequest: Partial<HttpSiteUsersRequest>,
    failsWithException = true
  ...
  public static async checkAndGetUserSitesAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    filteredRequest: Partial<HttpUserSitesGetRequest>,
    failsWithException = true
  ): Promise<AuthorizationFilter> {
    const authorizations: AuthorizationFilter = {
      filters: {},
  ...
  public static async checkAssignSiteUsersAuthorizations(
    tenant: Tenant,
    action: ServerAction,
    userToken: UserToken,
    filteredRequest: Partial<HttpSiteAssignUsersRequest>
  ): Promise<AuthorizationFilter> {
    const authorizations: AuthorizationFilter = {
      filters: {},
      dataSources: new Map(),
  ...
  public static async checkAssignUserSitesAuthorizations(
    ...
    action: ServerAction,
    userToken: UserToken,
    filteredRequest: Partial<HttpUserSitesAssignRequest>
  ): Promise<AuthorizationFilter> {
    const authorizations: AuthorizationFilter = {
      filters: {},
      dataSources: new Map(),
  ...
  public static async addUserSitesAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    userSites: UserSiteDataResult,
    authorizationFilter: AuthorizationFilter
  ): Promise<void> {
    // Add Meta Data
    userSites.metadata = authorizationFilter.metadata;
    // Add Authorizations
    userSites.canUpdateUserSites = await AuthorizationService.canPerformAuthorizationAction(
      tenant,
      userToken,
      Entity.USER_SITE,
      Action.UPDATE,
  ...
  public static async addUserSiteAuthToSitesAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    user: User,
    sites: Site[],
  ...
  public static async addSiteUsersAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    siteUsers: SiteUserDataResult,
    authorizationFilter: AuthorizationFilter
  ): Promise<void> {
    // Add Meta Data
    siteUsers.metadata = authorizationFilter.metadata;
    // Add Authorizations
    siteUsers.canUpdateSiteUsers = await AuthorizationService.canPerformAuthorizationAction(
      tenant,
      userToken,
      Entity.SITE_USER,
      Action.UPDATE,
  ...
  public static async addSiteUserAuthToUsersAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    site: Site,
    users: User[],
  ...
  public static async checkAndGetUsersInErrorAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    filteredRequest: Partial<HttpUsersGetRequest>
  ): Promise<AuthorizationFilter> {
    const authorizations: AuthorizationFilter = {
      filters: {},
      dataSources: new Map(),
  ...
  public static async addUsersAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    ...
    for (const user of users.result) {
      await AuthorizationService.addUserAuthorizations(
        tenant,
        userToken,
        user,
        authorizationFilter
  ...
  public static async addUserAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    user: User,
    authorizationFilter: AuthorizationFilter
    ...
    user.canListCompletedTransactions = await AuthorizationService.canPerformAuthorizationAction(
      ...
      userToken,
      Entity.TRANSACTION,
      Action.GET_COMPLETED_TRANSACTION,
      authorizationFilter,
      { UserID: user.id },
      user
    );
    user.canSynchronizeBillingUser = await AuthorizationService.canPerformAuthorizationAction(
      ...
      userToken,
      Entity.USER,
      Action.SYNCHRONIZE_BILLING_USER,
      authorizationFilter,
      { UserID: user.id },
      user
    );
  ...
  public static async checkAndGetUsersAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    authAction: Action,
    filteredRequest?: Partial<HttpUsersGetRequest>,
  ...
  public static async checkAndGetAssetsAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    authAction: Action,
    filteredRequest?: HttpAssetsGetRequest,
    failsWithException = true
  ): Promise<AuthorizationFilter> {
    const authorizations: AuthorizationFilter = {
      filters: {},
  ...
  public static async checkAndGetAssetAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    authAction: Action,
    filteredRequest: Partial<HttpAssetGetRequest>,
    entityData?: EntityData
  ): Promise<AuthorizationFilter> {
    return AuthorizationService.checkAndGetEntityAuthorizations(
      tenant,
      ...
      userToken,
      filteredRequest,
      filteredRequest.ID ? { AssetID: filteredRequest.ID } : {},
      authAction,
      entityData
    );
  }

  public static async addAssetsAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    assets: AssetDataResult,
    authorizationFilter: AuthorizationFilter
  ): Promise<void> {
    // Add Meta Data
    ...
    for (const asset of assets.result) {
      await AuthorizationService.addAssetAuthorizations(
        tenant,
        userToken,
        asset,
        authorizationFilter
  ...
  public static async addAssetAuthorizations(
    ...
    asset.canRetrieveConsumption =
      ...
      (await AuthorizationService.canPerformAuthorizationAction(
        ...
        userToken,
        Entity.ASSET,
        Action.RETRIEVE_CONSUMPTION,
        authorizationFilter,
        {},
        asset
      ));
    asset.canReadConsumption =
      asset.dynamicAsset &&
      (await AuthorizationService.canPerformAuthorizationAction(
        tenant,
        userToken,
        Entity.ASSET,
        Action.READ_CONSUMPTION,
        authorizationFilter,
        {},
        asset
      ));
    asset.canCreateConsumption =
      asset.dynamicAsset &&
      asset.usesPushAPI &&
      (await AuthorizationService.canPerformAuthorizationAction(
        tenant,
  ...
  public static async checkAndGetUserAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    filteredRequest: Partial<HttpUserGetRequest>,
    authAction: Action,
    entityData?: EntityData
  ): Promise<AuthorizationFilter> {
    return AuthorizationService.checkAndGetEntityAuthorizations(
      ...
      userToken,
      filteredRequest,
      filteredRequest.ID ? { UserID: filteredRequest.ID } : {},
      authAction,
      entityData
    );
  }

  public static async checkAndGetTagsAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    filteredRequest: Partial<HttpTagsGetRequest>,
    failsWithException = true
  ): Promise<AuthorizationFilter> {
    const authorizations: AuthorizationFilter = {
      filters: {},
  ...
  public static async checkAndGetTagAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    filteredRequest: Partial<HttpTagGetRequest>,
    authAction: Action,
    entityData?: EntityData
  ): Promise<AuthorizationFilter> {
    return AuthorizationService.checkAndGetEntityAuthorizations(
      ...
      userToken,
      filteredRequest,
      filteredRequest.ID ? { TagID: filteredRequest.ID } : {},
      authAction,
      entityData
    );
  }

  public static async addTagsAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    tags: TagDataResult,
    authorizationFilter: AuthorizationFilter
  ...
  public static async addTagAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    tag: Tag,
    authorizationFilter: AuthorizationFilter
  ...
  public static async checkAndGetRegistrationTokenAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    filteredRequest: Partial<HttpRegistrationTokenGetRequest>,
    authAction: Action,
    entityData?: EntityData
  ): Promise<AuthorizationFilter> {
    return AuthorizationService.checkAndGetEntityAuthorizations(
      ...
      userToken,
      filteredRequest,
      filteredRequest.ID ? { registrationTokenID: filteredRequest.ID } : {},
      authAction,
      entityData
    );
  }
  ...
  public static async checkAndGetRegistrationTokensAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    filteredRequest: Partial<HttpCompaniesGetRequest>,
    failsWithException = true
  ): Promise<AuthorizationFilter> {
    const authorizations: AuthorizationFilter = {
      filters: {},
  ...
  public static async addRegistrationTokensAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    registrationTokens: RegistrationTokenDataResult,
    authorizationFilter: AuthorizationFilter
  ): Promise<void> {
    // Add Meta Data
    ...
    for (const registrationToken of registrationTokens.result) {
      await AuthorizationService.addRegistrationTokenAuthorizations(
        tenant,
        userToken,
        registrationToken,
        authorizationFilter
  ...
  public static async addRegistrationTokenAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    ...
    // Build OCPP URLs
    registrationToken.ocpp15SOAPSecureUrl = Utils.buildOCPPServerSecureURL(
      tenant,
      OCPPVersion.VERSION_15,
      OCPPProtocol.SOAP,
      registrationToken.id
    );
    registrationToken.ocpp16SOAPSecureUrl = Utils.buildOCPPServerSecureURL(
      tenant,
      OCPPVersion.VERSION_16,
      OCPPProtocol.SOAP,
      registrationToken.id
    );
    registrationToken.ocpp16JSONSecureUrl = Utils.buildOCPPServerSecureURL(
      tenant,
      OCPPVersion.VERSION_16,
      OCPPProtocol.JSON,
      registrationToken.id
  ...
  public static async checkAndGetChargingStationTemplateAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    filteredRequest: Partial<HttpChargingStationTemplateGetRequest>,
    authAction: Action,
    entityData?: EntityData
  ): Promise<AuthorizationFilter> {
    return AuthorizationService.checkAndGetEntityAuthorizations(
      tenant,
      Entity.CHARGING_STATION_TEMPLATE,
      userToken,
      filteredRequest,
      filteredRequest.ID ? { chargingStationTemplateID: filteredRequest.ID } : {},
      authAction,
      entityData
    );
  }

  public static async checkAndGetChargingStationTemplatesAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    authAction: Action,
    filteredRequest: Partial<HttpChargingStationTemplatesGetRequest>
  ): Promise<AuthorizationFilter> {
  ...
  public static async addChargingStationTemplatesAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    chargingStationTemplates: ChargingStationTemplateDataResult,
    authorizationFilter: AuthorizationFilter
  ): Promise<void> {
    // Add Meta Data
    ...
    for (const chargingStationTemplate of chargingStationTemplates.result) {
      await AuthorizationService.addChargingStationTemplateAuthorizations(
        tenant,
        userToken,
  ...
  public static async addChargingStationTemplateAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
  ...
  public static async checkAndGetCompaniesAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    filteredRequest: Partial<HttpCompaniesGetRequest>,
    failsWithException = true
  ...
  public static async addCompaniesAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    companies: CompanyDataResult,
    authorizationFilter: AuthorizationFilter
  ): Promise<void> {
    // Add Meta Data
    ...
    for (const company of companies.result) {
      await AuthorizationService.addCompanyAuthorizations(
        tenant,
        userToken,
        company,
        authorizationFilter
  ...
  public static async addCompanyAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    company: Company,
    authorizationFilter: AuthorizationFilter
  ...
  public static async checkAndGetCompanyAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    filteredRequest: Partial<HttpCompanyGetRequest>,
    authAction: Action,
    entityData?: EntityData
  ): Promise<AuthorizationFilter> {
    return AuthorizationService.checkAndGetEntityAuthorizations(
      ...
      userToken,
      filteredRequest,
      filteredRequest.ID ? { CompanyID: filteredRequest.ID } : {},
      authAction,
      entityData
    );
  }
  ...
  public static async checkAndGetPricingDefinitionsAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    filteredRequest: Partial<HttpPricingDefinitionsGetRequest>,
    failsWithException = true
  ): Promise<AuthorizationFilter> {
    const authorizations: AuthorizationFilter = {
      filters: {},
  ...
  public static async addPricingDefinitionsAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    pricingDefinitions: PricingDefinitionDataResult,
    authorizationFilter: AuthorizationFilter
  ): Promise<void> {
    // Add Meta Data
    ...
    for (const pricingDefinition of pricingDefinitions.result) {
      await AuthorizationService.addPricingDefinitionAuthorizations(
        tenant,
        userToken,
        pricingDefinition,
        authorizationFilter
  ...
  public static async addPricingDefinitionAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    ...
    pricingDefinition.canRead = await AuthorizationService.canPerformAuthorizationAction(
      ...
      Action.READ,
      filter,
      { CompanyID: pricingDefinition.id },
      pricingDefinition
    );
  ...
  public static async checkAndGetPricingDefinitionAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    filteredRequest: Partial<HttpPricingDefinitionGetRequest>,
    authAction: Action,
    entityData?: EntityData
  ): Promise<AuthorizationFilter> {
    return AuthorizationService.checkAndGetEntityAuthorizations(
      ...
      userToken,
      filteredRequest,
      filteredRequest.ID ? { PricingID: filteredRequest.ID } : {},
      authAction,
      entityData
    );
  }

  public static async checkAndGetSiteAreaAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    filteredRequest: Partial<HttpSiteAreaGetRequest>,
    authAction: Action,
    entityData?: EntityData
  ): Promise<AuthorizationFilter> {
    return AuthorizationService.checkAndGetEntityAuthorizations(
      ...
      userToken,
      filteredRequest,
      filteredRequest.ID ? { SiteAreaID: filteredRequest.ID } : {},
      authAction,
      entityData
    );
  }
  ...
  public static async checkAndGetSiteAreasAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    filteredRequest: Partial<HttpSiteAreasGetRequest>,
    failsWithException = true
  ): Promise<AuthorizationFilter> {
    const authorizations: AuthorizationFilter = {
      filters: {},
  ...
  public static async addSiteAreasAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    siteAreas: SiteAreaDataResult,
    authorizationFilter: AuthorizationFilter
  ): Promise<void> {
    // Add Meta Data
    ...
    for (const siteArea of siteAreas.result) {
      await AuthorizationService.addSiteAreaAuthorizations(
        tenant,
        userToken,
        siteArea,
        authorizationFilter
  ...
  public static async addSiteAreaAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    siteArea: SiteArea,
    authorizationFilter: AuthorizationFilter
    ...
    siteArea.canUpdate = await AuthorizationService.canPerformAuthorizationAction(
      ...
      Action.UPDATE,
      authorizationFilter,
      { SiteAreaID: siteArea.id, SiteID: siteArea.siteID },
      siteArea
    );
    ...
    siteArea.canAssignAssets = await AuthorizationService.canPerformAuthorizationAction(
      ...
      userToken,
      Entity.SITE_AREA,
      Action.ASSIGN_ASSETS_TO_SITE_AREA,
      authorizationFilter,
      { SiteAreaID: siteArea.id, SiteID: siteArea.siteID },
      siteArea
    );
    siteArea.canUnassignAssets = await AuthorizationService.canPerformAuthorizationAction(
      ...
      userToken,
      Entity.SITE_AREA,
      Action.UNASSIGN_ASSETS_FROM_SITE_AREA,
      authorizationFilter,
      { SiteAreaID: siteArea.id, SiteID: siteArea.siteID },
      siteArea
    );
    ...
    siteArea.canUnassignChargingStations = await AuthorizationService.canPerformAuthorizationAction(
      ...
      userToken,
      Entity.SITE_AREA,
      Action.UNASSIGN_CHARGING_STATIONS_FROM_SITE_AREA,
      authorizationFilter,
      { SiteAreaID: siteArea.id, SiteID: siteArea.siteID },
      siteArea
    );
    siteArea.canReadChargingStations = await AuthorizationService.canPerformAuthorizationAction(
      ...
      userToken,
      Entity.SITE_AREA,
      Action.READ_CHARGING_STATIONS_FROM_SITE_AREA,
      authorizationFilter,
      { SiteAreaID: siteArea.id, SiteID: siteArea.siteID, Issuer: siteArea.issuer },
      siteArea
    );
  ...
  public static async checkAndGetChargingProfilesAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    authAction: Action,
    filteredRequest?: HttpChargingProfilesGetRequest,
    failsWithException = true
  ): Promise<AuthorizationFilter> {
    const authorizations: AuthorizationFilter = {
      filters: {},
  ...
  public static async addChargingProfilesAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    chargingProfiles: ChargingProfileDataResult,
    authorizationFilter: AuthorizationFilter
  ): Promise<void> {
    // Add Meta Data
    ...
    for (const chargingProfile of chargingProfiles.result) {
      await AuthorizationService.addChargingProfileAuthorizations(
        tenant,
        userToken,
        chargingProfile,
        authorizationFilter
  ...
  public static async addChargingProfileAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    ...
    chargingProfile.canUpdate = await AuthorizationService.canPerformAuthorizationAction(
      ...
      authorizationFilter,
      {
        chargingStationID: chargingProfile.id,
  ...
  public static async checkAndGetChargingProfileAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    filteredRequest: Partial<HttpChargingProfileRequest>,
    authAction: Action,
    entityData?: EntityData
  ): Promise<AuthorizationFilter> {
    return AuthorizationService.checkAndGetEntityAuthorizations(
  ...
  public static async checkAndGetChargingStationAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    filteredRequest: Partial<HttpChargingStationGetRequest>,
    authAction: Action,
    entityData?: EntityData
  ): Promise<AuthorizationFilter> {
    return AuthorizationService.checkAndGetEntityAuthorizations(
  ...
  public static async checkAndGetChargingStationsAuthorizations(
    ...
    userToken: UserToken,
    authAction: Action,
    filteredRequest?: HttpChargingStationsGetRequest,
    failsWithException = true
  ): Promise<AuthorizationFilter> {
    const authorizations: AuthorizationFilter = {
      filters: {},
  ...
  public static async addChargingStationsAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    chargingStations: ChargingStationDataResult,
    authorizationFilter: AuthorizationFilter
  ): Promise<void> {
    // Add Meta Data
    ...
    for (const chargingStation of chargingStations.result) {
      await AuthorizationService.addChargingStationAuthorizations(
        tenant,
        userToken,
        chargingStation,
        authorizationFilter
  ...
  public static async addChargingStationAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    ...
    chargingStation.canListUsers = await AuthorizationService.canPerformAuthorizationAction(
      ...
      Action.LIST,
      authorizationFilter,
      { chargingStationID: chargingStation.id, SiteID: chargingStation.siteID },
      chargingStation
    );
    ...
    chargingStation.canDeleteChargingProfile =
      await AuthorizationService.canPerformAuthorizationAction(
        ...
        userToken,
        Entity.CHARGING_STATION,
        Action.DELETE_CHARGING_PROFILE,
        authorizationFilter,
        { chargingStationID: chargingStation.id, SiteID: chargingStation.siteID },
        chargingStation
      );
    chargingStation.canGetOCPPParams = await AuthorizationService.canPerformAuthorizationAction(
      ...
      userToken,
      Entity.CHARGING_STATION,
      Action.GET_OCPP_PARAMS,
      authorizationFilter,
      { chargingStationID: chargingStation.id, SiteID: chargingStation.siteID },
      chargingStation
    );
    chargingStation.canUpdateChargingProfile =
      await AuthorizationService.canPerformAuthorizationAction(
        tenant,
        userToken,
        Entity.CHARGING_STATION,
        Action.UPDATE_CHARGING_PROFILE,
        authorizationFilter,
        { chargingStationID: chargingStation.id, SiteID: chargingStation.siteID },
        chargingStation
      );
    chargingStation.canGetConnectorQRCode =
      await AuthorizationService.canPerformAuthorizationAction(
        tenant,
        userToken,
        Entity.CHARGING_STATION,
        Action.GET_CONNECTOR_QR_CODE,
        authorizationFilter,
        { chargingStationID: chargingStation.id, SiteID: chargingStation.siteID },
        chargingStation
      );
    ...
    chargingStation.canChangeConfiguration =
      await AuthorizationService.canPerformAuthorizationAction(
        tenant,
        userToken,
        Entity.CHARGING_STATION,
    ...
    chargingStation.canSetChargingProfile =
      await AuthorizationService.canPerformAuthorizationAction(
        tenant,
        userToken,
        Entity.CHARGING_STATION,
    ...
    chargingStation.canGetCompositeSchedule =
      await AuthorizationService.canPerformAuthorizationAction(
        tenant,
        userToken,
        Entity.CHARGING_STATION,
    ...
    chargingStation.canClearChargingProfile =
      await AuthorizationService.canPerformAuthorizationAction(
        tenant,
        userToken,
        Entity.CHARGING_STATION,
    ...
    chargingStation.canRemoteStopTransaction =
      await AuthorizationService.canPerformAuthorizationAction(
        tenant,
        userToken,
        Entity.CHARGING_STATION,
    ...
    chargingStation.canChangeAvailability =
      await AuthorizationService.canPerformAuthorizationAction(
        tenant,
        userToken,
        Entity.CHARGING_STATION,
    ...
    chargingStation.canRemoteStartTransaction =
      await AuthorizationService.canPerformAuthorizationAction(
        tenant,
        userToken,
        Entity.CHARGING_STATION,
    ...
    chargingStation.canMaintainPricingDefinitions =
      await AuthorizationService.canPerformAuthorizationAction(
        tenant,
        userToken,
        Entity.CHARGING_STATION,
    ...
    chargingStation.canPushTransactionCDR =
      await AuthorizationService.canPerformAuthorizationAction(
        tenant,
        userToken,
        Entity.CHARGING_STATION,
        Action.PUSH_TRANSACTION_CDR,
        authorizationFilter,
        { chargingStationID: chargingStation.id, SiteID: chargingStation.siteID },
        chargingStation
      );
    chargingStation.canListCompletedTransactions =
      await AuthorizationService.canPerformAuthorizationAction(
        tenant,
        userToken,
        Entity.TRANSACTION,
    ...
    for (const connector of chargingStation.connectors || []) {
      ...
      connector.canRemoteStartTransaction =
        (await AuthorizationService.canPerformAuthorizationAction(
          tenant,
          userToken,
          Entity.CONNECTOR,
      ...
      // Unlock connector
      connector.canUnlockConnector =
        !chargingStation.inactive &&
        chargingStation.canUnlockConnector &&
        ![ChargePointStatus.AVAILABLE, ChargePointStatus.UNAVAILABLE].includes(connector.status);
  ...
  public static async checkAndGetBillingAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    authAction: Action,
    entityData?: EntityData
  ...
  public static async checkAndGetBillingPlatformAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    authAction: Action,
    entityData?: EntityData
  ...
  public static async checkAndGetBillingAccountAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    filteredRequest: Partial<HttpBillingAccountGetRequest>,
    authAction: Action,
    entityData?: EntityData
  ): Promise<AuthorizationFilter> {
    return AuthorizationService.checkAndGetEntityAuthorizations(
      ...
      userToken,
      filteredRequest,
      filteredRequest.ID ? { id: filteredRequest.ID } : {},
      authAction,
      entityData
    );
  }

  public static async checkAndGetBillingAccountsAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    filteredRequest?: Partial<HttpBillingAccountsGetRequest>,
    failsWithException = true
  ): Promise<AuthorizationFilter> {
    const authorizations: AuthorizationFilter = {
      filters: {},
  ...
  public static async checkAndGetTransfersAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    authAction: Action,
    filteredRequest?: Partial<HttpBillingTransfersGetRequest>,
    failsWithException = true
  ): Promise<AuthorizationFilter> {
    const authorizations: AuthorizationFilter = {
      filters: {},
  ...
  public static async checkAndGetTransferAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    filteredRequest: Partial<HttpBillingTransferGetRequest>,
    authAction: Action,
    entityData?: EntityData
  ): Promise<AuthorizationFilter> {
    return AuthorizationService.checkAndGetEntityAuthorizations(
      ...
      userToken,
      filteredRequest,
      filteredRequest.ID ? { TransferID: filteredRequest.ID } : {},
      authAction,
      entityData
    );
  }

  public static async checkAndGetTaxesAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    failsWithException = true
  ): Promise<AuthorizationFilter> {
  ...
  public static async checkAndGetInvoicesAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    filteredRequest: Partial<HttpBillingInvoicesRequest>,
    failsWithException = true
  ): Promise<AuthorizationFilter> {
    const authorizations: AuthorizationFilter = {
      filters: {},
  ...
  public static async checkAndGetInvoiceAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    filteredRequest: Partial<HttpBillingInvoiceRequest>,
    authAction: Action,
    entityData?: EntityData
  ): Promise<AuthorizationFilter> {
    return AuthorizationService.checkAndGetEntityAuthorizations(
      ...
      userToken,
      filteredRequest,
      filteredRequest.ID ? { invoiceID: filteredRequest.ID } : {},
      authAction,
      entityData
    );
  }

  public static addTaxesAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    billingTaxes: BillingTaxDataResult,
    authorizationFilter: AuthorizationFilter
  ): void {
    // Add Meta Data
  ...
  public static addTaxAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
  ...
  public static async addInvoicesAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    billingInvoices: BillingInvoiceDataResult,
    authorizationFilter: AuthorizationFilter
  ): Promise<void> {
    // Add Meta Data
    ...
    for (const billingInvoice of billingInvoices.result) {
      await AuthorizationService.addInvoiceAuthorizations(
        tenant,
        userToken,
        billingInvoice,
        authorizationFilter
  ...
  public static async addInvoiceAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    ...
    billingInvoice.canDownload = await AuthorizationService.canPerformAuthorizationAction(
      ...
      Action.DOWNLOAD,
      authorizationFilter,
      billingInvoice.userID ? { UserID: billingInvoice.userID } : {},
      billingInvoice
    );
    // Optimize data over the net
  ...
  public static async addTransfersAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    billingAccounts: BillingTransfersDataResult,
    authorizationFilter: AuthorizationFilter
  ): Promise<void> {
    // Add Meta Data
    ...
    for (const billingAcount of billingAccounts.result) {
      await AuthorizationService.addTransferAuthorizations(
        tenant,
        userToken,
        billingAcount,
        authorizationFilter
  ...
  public static async addTransferAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    billingTransfer: BillingTransfer,
    authorizationFilter: AuthorizationFilter
  ): Promise<void> {
    ...
    billingTransfer.canDownload = await AuthorizationService.canPerformAuthorizationAction(
      ...
      Action.DOWNLOAD,
      authorizationFilter,
      billingTransfer.invoice ? { UserID: billingTransfer.invoice.userID } : {},
      billingTransfer
    );
    // Optimize data over the net
  ...
  public static async addAccountsAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    billingAccounts: BillingAccountsDataResult,
    authorizationFilter: AuthorizationFilter
  ): Promise<void> {
    // Add Meta Data
    billingAccounts.metadata = authorizationFilter.metadata;
  ...
  public static addAccountAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
  ...
  public static async checkAndGetPaymentMethodsAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    filteredRequest: Partial<HttpPaymentMethods>,
    failsWithException = true
  ): Promise<AuthorizationFilter> {
    const authorizations: AuthorizationFilter = {
      filters: {},
    ...
    await AuthorizationService.canPerformAuthorizationAction(
      ...
      Action.LIST,
      authorizations,
      filteredRequest.userID ? { UserID: filteredRequest.userID } : {},
      null,
      failsWithException
    );
    return authorizations;
  ...
  public static async checkAndGetPaymentMethodAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    filteredRequest: Partial<HttpSetupPaymentMethod | HttpDeletePaymentMethod>,
    authAction: Action,
    entityData?: EntityData
  ): Promise<AuthorizationFilter> {
    return AuthorizationService.checkAndGetEntityAuthorizations(
  ...
  public static async addPaymentMethodsAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    billingPaymentMethods: BillingPaymentMethodDataResult,
    authorizationFilter: AuthorizationFilter,
    filteredRequest: Partial<HttpPaymentMethods>
  ): Promise<void> {
    // Add Meta Data
    ...
    for (const billingPaymentMethod of billingPaymentMethods.result) {
      await AuthorizationService.addPaymentMethodAuthorizations(
        tenant,
        userToken,
        billingPaymentMethod,
        authorizationFilter
  ...
  public static async addPaymentMethodAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    ...
    billingPaymentMethod.canDelete =
      !billingPaymentMethod.isDefault &&
      (await AuthorizationService.canPerformAuthorizationAction(
        tenant,
        userToken,
        Entity.PAYMENT_METHOD,
  ...
  public static async checkAndGetSettingsAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    authAction: Action,
    filteredRequest: Partial<HttpPaymentMethods>,
  ...
  public static async checkAndGetSettingAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    filteredRequest: Partial<HttpSettingGetRequest>,
    authAction: Action,
    entityData?: EntityData
  ): Promise<AuthorizationFilter> {
    return AuthorizationService.checkAndGetEntityAuthorizations(
      ...
      userToken,
      filteredRequest,
      filteredRequest.ID ? { SettingID: filteredRequest.ID } : {},
      authAction,
      entityData
    );
  }

  public static async addSettingsAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    settings: SettingDBDataResult,
    authorizationFilter: AuthorizationFilter,
    filteredRequest: Partial<HttpSettingsGetRequest>
  ): Promise<void> {
    // Add Meta Data
    ...
    settings.canCreate = await AuthorizationService.canPerformAuthorizationAction(
      ...
      Action.CREATE,
      authorizationFilter,
      filteredRequest.Identifier ? { ID: filteredRequest.Identifier } : {}
    );
    for (const setting of settings.result) {
      await AuthorizationService.addSettingAuthorizations(
        tenant,
        userToken,
        setting,
        authorizationFilter
  ...
  public static async addSettingAuthorizations(
    ...
    setting.canDelete = await AuthorizationService.canPerformAuthorizationAction(
      tenant,
      userToken,
      Entity.SETTING,
      Action.DELETE,
    ...
    setting.canSyncRefund = await AuthorizationService.canPerformAuthorizationAction(
      tenant,
      userToken,
      Entity.TRANSACTION,
      Action.SYNCHRONIZE_REFUNDED_TRANSACTION,
      authorizationFilter
    );
    setting.canCheckBillingConnection = await AuthorizationService.canPerformAuthorizationAction(
      tenant,
      userToken,
      Entity.BILLING,
      Action.CHECK_CONNECTION,
    ...
    setting.canCheckSmartChargingConnection =
      await AuthorizationService.canPerformAuthorizationAction(
        tenant,
        userToken,
        Entity.SMART_CHARGING,
        Action.CHECK_CONNECTION,
        authorizationFilter
      );
    setting.canCheckAssetConnection = await AuthorizationService.canPerformAuthorizationAction(
      tenant,
      userToken,
      Entity.ASSET,
      Action.CHECK_CONNECTION,
  ...
  public static async checkAndGetOCPIEndpointsAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    authAction: Action,
    filteredRequest?: Partial<HttpOCPIEndpointGetRequest>,
    failsWithException = true
  ): Promise<AuthorizationFilter> {
    const authorizations: AuthorizationFilter = {
      filters: {},
  ...
  public static async checkAndGetOCPIEndpointAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    filteredRequest: Partial<HttpOCPIEndpointGetRequest>,
    authAction: Action,
    ...
    return AuthorizationService.checkAndGetEntityAuthorizations(
      ...
      userToken,
      filteredRequest,
      filteredRequest.ID ? { OcpiEndpointID: filteredRequest.ID } : {},
      authAction,
      entityData
    );
  }

  public static async addOCPIEndpointsAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    ocpiEndpoints: OcpiEndpointDataResult,
    authorizationFilter: AuthorizationFilter,
    filteredRequest?: Partial<HttpSettingsGetRequest>
  ): Promise<void> {
    // Add Meta Data
    ...
    for (const ocpiEndpoint of ocpiEndpoints.result) {
      await AuthorizationService.addOCPIEndpointAuthorizations(
        tenant,
        userToken,
        ocpiEndpoint,
        authorizationFilter
  ...
  public static async addOCPIEndpointAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    ...
    ocpiEndpoint.canUpdate = await AuthorizationService.canPerformAuthorizationAction(
      tenant,
      userToken,
      Entity.OCPI_ENDPOINT,
      Action.UPDATE,
    ...
    ocpiEndpoint.canDelete = await AuthorizationService.canPerformAuthorizationAction(
      tenant,
      userToken,
      Entity.OCPI_ENDPOINT,
      Action.DELETE,
    ...
    ocpiEndpoint.canGenerateLocalToken = await AuthorizationService.canPerformAuthorizationAction(
      tenant,
      userToken,
      Entity.OCPI_ENDPOINT,
      Action.GENERATE_LOCAL_TOKEN,
    ...
    ocpiEndpoint.canPing = await AuthorizationService.canPerformAuthorizationAction(
      tenant,
      userToken,
      Entity.OCPI_ENDPOINT,
      Action.PING,
    ...
    ocpiEndpoint.canRegister = await AuthorizationService.canPerformAuthorizationAction(
      tenant,
      userToken,
      Entity.OCPI_ENDPOINT,
      Action.REGISTER,
    ...
    ocpiEndpoint.canTriggerJob = await AuthorizationService.canPerformAuthorizationAction(
      tenant,
      userToken,
      Entity.OCPI_ENDPOINT,
      Action.TRIGGER_JOB,
  ...
  public static async checkAndGetCarsAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    filteredRequest: Partial<HttpCarsGetRequest>,
    failsWithException = true
  ): Promise<AuthorizationFilter> {
    const authorizations: AuthorizationFilter = {
      filters: {},
  ...
  public static async checkAndGetCarAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    filteredRequest: Partial<HttpCarGetRequest>,
    authAction: Action,
    entityData?: EntityData
  ): Promise<AuthorizationFilter> {
    return AuthorizationService.checkAndGetEntityAuthorizations(
      ...
      userToken,
      filteredRequest,
      filteredRequest.ID ? { CarID: filteredRequest.ID } : {},
      authAction,
      entityData
    );
  }

  public static async addCarsAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    cars: CarDataResult,
    authorizationFilter: AuthorizationFilter
  ...
  public static async addCarAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    car: Car,
    authorizationFilter: AuthorizationFilter
  ...
  public static async checkAndGetCarCatalogsAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    authAction: Action,
    filteredRequest?: Partial<HttpCarCatalogsGetRequest>,
    failsWithException = true
  ): Promise<AuthorizationFilter> {
    const authorizations: AuthorizationFilter = {
      filters: {},
  ...
  public static async checkAndGetCarCatalogAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    filteredRequest: Partial<HttpCarCatalogGetRequest>,
    authAction: Action,
    entityData?: EntityData
  ): Promise<AuthorizationFilter> {
    return AuthorizationService.checkAndGetEntityAuthorizations(
      ...
      userToken,
      filteredRequest,
      filteredRequest.ID ? { CarCatalogID: filteredRequest.ID } : {},
      authAction,
      entityData
    );
  }

  public static async addCarCatalogsAuthorizationActions(
    tenant: Tenant,
    userToken: UserToken,
    carCatalogs: CarCatalogDataResult,
    authorizationFilter: AuthorizationFilter
  ): Promise<void> {
    // Add Meta Data
    ...
    for (const carCatalog of carCatalogs.result) {
      await AuthorizationService.addCarCatalogAuthorizations(
        tenant,
        userToken,
        carCatalog,
        authorizationFilter
  ...
  public static async addCarCatalogAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
  ...
  public static async checkAndGetTransactionsAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    authAction: Action,
    filteredRequest?: Partial<HttpTransactionConsumptionsGetRequest>,
    failsWithException = true
  ): Promise<AuthorizationFilter> {
    const authorizations: AuthorizationFilter = {
      filters: {},
  ...
  public static async checkAndGetTransactionAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    filteredRequest: Partial<HttpTransactionGetRequest>,
    authAction: Action,
    entityData?: EntityData
  ): Promise<AuthorizationFilter> {
    return AuthorizationService.checkAndGetEntityAuthorizations(
      ...
      userToken,
      filteredRequest,
      filteredRequest.ID ? { TransactionID: filteredRequest.ID } : {},
      authAction,
      entityData
    );
  }

  public static async addTransactionsAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    transactions: TransactionDataResult,
    authorizationFilter: AuthorizationFilter
  ): Promise<void> {
    // Add Meta Data
    transactions.metadata = authorizationFilter.metadata;
    transactions.canListUsers = await AuthorizationService.canPerformAuthorizationAction(
      tenant,
      userToken,
      Entity.USER,
      Action.LIST,
    ...
    transactions.canListSites = await AuthorizationService.canPerformAuthorizationAction(
      tenant,
      userToken,
      Entity.SITE,
      Action.LIST,
    ...
    transactions.canListSiteAreas = await AuthorizationService.canPerformAuthorizationAction(
      tenant,
      userToken,
      Entity.SITE_AREA,
      Action.LIST,
    ...
    transactions.canListChargingStations = await AuthorizationService.canPerformAuthorizationAction(
      tenant,
      userToken,
      Entity.CHARGING_STATION,
      Action.LIST,
    ...
    transactions.canListTags = await AuthorizationService.canPerformAuthorizationAction(
      tenant,
      userToken,
      Entity.TAG,
      Action.LIST,
    ...
    transactions.canExport = await AuthorizationService.canPerformAuthorizationAction(
      tenant,
      userToken,
      Entity.TRANSACTION,
      Action.EXPORT,
    ...
    transactions.canDelete = await AuthorizationService.canPerformAuthorizationAction(
      tenant,
      userToken,
      Entity.TRANSACTION,
      Action.DELETE,
    ...
    transactions.canSyncRefund = await AuthorizationService.canPerformAuthorizationAction(
      tenant,
      userToken,
      Entity.TRANSACTION,
      Action.SYNCHRONIZE_REFUNDED_TRANSACTION,
    ...
    transactions.canRefund = await AuthorizationService.canPerformAuthorizationAction(
      tenant,
      userToken,
      Entity.TRANSACTION,
    ...
    transactions.canReadSetting = await AuthorizationService.canPerformAuthorizationAction(
      tenant,
      userToken,
      Entity.SETTING,
      Action.READ,
    ...
    for (const transaction of transactions.result) {
      await AuthorizationService.addTransactionAuthorizations(
        tenant,
        userToken,
        transaction,
        authorizationFilter
  ...
  public static async addTransactionAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    ...
    const dynamicAuthorizationFilter: DynamicAuthorizationsFilter = {
    ...
    transaction.canDelete = await AuthorizationService.canPerformAuthorizationAction(
      ...
      Action.DELETE,
      authorizationFilter,
      { TransactionID: transaction.id, ...dynamicAuthorizationFilter },
      transaction
    );
    ...
    transaction.canSynchronizeRefundedTransaction =
      await AuthorizationService.canPerformAuthorizationAction(
        tenant,
        userToken,
        Entity.TRANSACTION,
    ...
    transaction.canGetAdvenirConsumption = await AuthorizationService.canPerformAuthorizationAction(
      ...
      userToken,
      Entity.TRANSACTION,
      Action.GET_ADVENIR_CONSUMPTION,
      authorizationFilter,
      { TransactionID: transaction.id, ...dynamicAuthorizationFilter },
      transaction
    );
    ...
    transaction.canListLogs = await this.canPerformAuthorizationAction(
      tenant,
      userToken,
      Entity.LOGGING,
      Action.LIST,
    ...
    transaction.canReadChargingStation = await this.canPerformAuthorizationAction(
      tenant,
      userToken,
      Entity.CHARGING_STATION,
      Action.READ,
    ...
    transaction.canRefundTransaction =
      (await AuthorizationService.canPerformAuthorizationAction(
        tenant,
        userToken,
        Entity.TRANSACTION,
    ...
    transaction.canPushTransactionCDR =
      transaction.ocpi &&
    ...
    transaction.canExportOcpiCdr =
      ...
      (await AuthorizationService.canPerformAuthorizationAction(
        ...
        userToken,
        Entity.TRANSACTION,
        Action.EXPORT_OCPI_CDR,
        authorizationFilter,
        { TransactionID: transaction.id, ...dynamicAuthorizationFilter },
        transaction
      ));
    // Set sensible data
    const sensibleUserData = {
      UserData: true,
      TagData: true,
      CarCatalogData: true,
      CarData: true,
    ...
    await AuthorizationService.canPerformAuthorizationAction(
      ...
      Action.VIEW_USER_DATA,
      authorizationFilter,
      { TransactionID: transaction.id, ...dynamicAuthorizationFilter, ...sensibleUserData },
      transaction
    );
  ...
  public static async addTransactionsInErrorAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    transactions: TransactionInErrorDataResult,
    authorizationFilter: AuthorizationFilter
  ): Promise<void> {
    // Add Meta Data
    transactions.metadata = authorizationFilter.metadata;
    ...
    // Add Authorizations
    for (const transaction of transactions.result) {
      await AuthorizationService.addTransactionInErrorAuthorizations(
        tenant,
        userToken,
        transaction,
        authorizationFilter
  ...
  public static async addTransactionInErrorAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    transaction: TransactionInError,
    authorizationFilter: AuthorizationFilter
  ): Promise<void> {
    // Set entity dynamic auth filters that will be used by auth framework
    const dynamicAuthorizationFilter: DynamicAuthorizationsFilter = {
  ...
  public static async addRefundReportsAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    refundReports: RefundReport[],
    authorizationFilter: AuthorizationFilter
  ): Promise<void> {
    // Add Authorizations
    for (const refundReport of refundReports) {
      await AuthorizationService.addRefundReportAuthorizations(
        tenant,
        userToken,
        refundReport,
        authorizationFilter
  ...
  public static async addRefundReportAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
  ...
  public static async checkAndGetConsumptionsAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    authAction: Action,
    filteredRequest?: Partial<HttpByIDRequest>,
    failsWithException = true
  ): Promise<AuthorizationFilter> {
    const authorizations: AuthorizationFilter = {
      filters: {},
  ...
  public static async checkAndGetSmartChargingAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    authAction: Action,
    failsWithException = true
  ...
  public static async checkAndGetStatisticsAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    authAction: Action,
    filteredRequest?: Partial<HttpStatisticsGetRequest>,
    failsWithException = true
  ): Promise<AuthorizationFilter> {
    const authorizations: AuthorizationFilter = {
      filters: {},
  ...
  public static async addStatisticsAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    statistics: StatisticDataResult,
    authorizationFilter: AuthorizationFilter
  ): Promise<void> {
    // Add Authorizations
  ...
  public static async checkAndGetReservationsAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    authAction: Action,
    filteredRequest?: Partial<HttpReservationGetRequest>,
    failsWithException = true
  ): Promise<AuthorizationFilter> {
    const authorizations: AuthorizationFilter = {
      filters: {},
  ...
  public static async checkAndGetReservationAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    filteredRequest: Partial<HttpReservationGetRequest>,
    authAction: Action,
    ...
    return AuthorizationService.checkAndGetEntityAuthorizations(
      ...
      userToken,
      filteredRequest,
      filteredRequest.ID ? { ReservationID: filteredRequest.ID } : {},
      authAction,
      entityData
    );
  }

  public static async addReservationsAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
    reservations: ReservationDataResult,
    authorizationFilter: AuthorizationFilter
  ): Promise<void> {
    // Add Meta Data
    reservations.metadata = authorizationFilter.metadata;
    // Add Authorizations
    reservations.canCreate = await AuthorizationService.canPerformAuthorizationAction(
      tenant,
      userToken,
      Entity.RESERVATION,
      Action.CREATE,
    ...
    reservations.canListCompanies = await AuthorizationService.canPerformAuthorizationAction(
      tenant,
      userToken,
      Entity.COMPANY,
      Action.LIST,
    ...
    reservations.canListSiteAreas = await AuthorizationService.canPerformAuthorizationAction(
      tenant,
      userToken,
      Entity.SITE_AREA,
      Action.LIST,
    ...
    reservations.canListSites = await AuthorizationService.canPerformAuthorizationAction(
      tenant,
      userToken,
      Entity.SITE,
      Action.LIST,
    ...
    reservations.canListTags = await AuthorizationService.canPerformAuthorizationAction(
      tenant,
      userToken,
      Entity.TAG,
      Action.LIST,
    ...
    reservations.canListUsers = await AuthorizationService.canPerformAuthorizationAction(
      tenant,
      userToken,
      Entity.USER,
      Action.LIST,
  ...
  public static async addReservationAuthorizations(
    tenant: Tenant,
    userToken: UserToken,
  ...
  private static filterProjectFields(authFields: string[], httpProjectField: string): string[] {
    ...
    if (!Utils.isEmptyArray(applicableProjectedFields) && !Utils.isEmptyArray(httpProjectFields)) {
      httpProjectFields = httpProjectFields.filter((httpProjectField) =>
        applicableProjectedFields.includes(httpProjectField)
      );
    }
  ...
  private static async processDynamicFilters(
    tenant: Tenant,
    userToken: UserToken,
    authAction: Action,
    authEntity: Entity,
      ...
      for (let filtersToProcess of authorizationContext.filters) {
        ...
        for (const filterToProcess of filtersToProcess) {
          ...
          const dynamicFilter = await DynamicAuthorizationFactory.getDynamicFilter(
            ...
            userToken,
            filterToProcess,
            authorizationFilters.dataSources
          );
          if (!dynamicFilter) {
  ...
  private static processDynamicAsserts(
    tenant: Tenant,
    userToken: UserToken,
    authAction: Action,
    authEntity: Entity,
  ...
  private static async canPerformAuthorizationAction(
    tenant: Tenant,
    userToken: UserToken,
    authEntity: Entity,
    authAction: Action,
    authorizationFilters: AuthorizationFilter,
    filteredRequest?: Record<string, any>,
    entityData?: EntityData,
    failsWithException = false
  ): Promise<boolean> {
    // Check static auth
    const authorizationContext: AuthorizationContext = {};
    const authResult = await Authorizations.can(
      userToken,
      authEntity,
      authAction,
      authorizationContext
    ...
    if (!authorizationFilters.authorized) {
      if (failsWithException) {
        throw new AppAuthError({
          ...
          entity: authEntity,
          module: MODULE_NAME,
          method: 'canPerformAuthorizationAction',
        });
      }
      return false;
    }
    // Process Dynamic Filters
    await AuthorizationService.processDynamicFilters(
      tenant,
      userToken,
      authAction,
      authEntity,
    ...
    if (authorizationFilters.authorized) {
      ...
      AuthorizationService.processDynamicAsserts(
        tenant,
        userToken,
        authAction,
        authEntity,
  ...
  private static async checkAndGetEntityAuthorizations(
    tenant: Tenant,
    authEntity: Entity,
    userToken: UserToken,
    filteredRequest: Record<string, any>,
    ...
    if (!authorizations.authorized) {
      throw new AppAuthError({
        ...
        entity: authEntity,
        module: MODULE_NAME,
        method: 'checkAndGetEntityAuthorizations',
      });
    }
    // Process Dynamic Filters
    await AuthorizationService.processDynamicFilters(
