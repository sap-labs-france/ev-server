...
export default class CarService {
  public static async handleGetCarCatalogs(
    action: ServerAction,
    req: Request,
    res: Response,
    next: NextFunction
    ...
    if (!Authorizations.isSuperAdmin(req.user)) {
      UtilsService.assertComponentIsActiveFromToken(
        req.user,
        TenantComponents.CAR,
        Action.LIST,
        Entity.CAR_CATALOG,
        MODULE_NAME,
        'handleGetCarCatalogs'
      );
    }
    // Filter
    ...
    if (filteredRequest.WithAuth) {
      await AuthorizationService.addCarCatalogsAuthorizationActions(
        req.tenant,
        req.user,
        carCatalogs as CarCatalogDataResult,
        authorizations
      );
    }
  ...
  public static async handleGetCarCatalog(
    action: ServerAction,
    req: Request,
    res: Response,
    next: NextFunction
  ...
  public static async handleGetCarCatalogImage(
    action: ServerAction,
    req: Request,
    res: Response,
    next: NextFunction
  ...
  public static async handleGetCarCatalogImages(
    action: ServerAction,
    req: Request,
    res: Response,
    next: NextFunction
    ...
    if (!Authorizations.isSuperAdmin(req.user)) {
      UtilsService.assertComponentIsActiveFromToken(
        ...
        Entity.CAR_CATALOG,
        MODULE_NAME,
        'handleGetCarCatalogImages'
      );
    }
    // Filter
    const filteredRequest = CarValidatorRest.getInstance().validateCarCatalogImagesGetReq(
      req.query
    );
    // Check dynamic auth
    ...
    // Get the car
    const carCatalogImages = await CarStorage.getCarCatalogImages(filteredRequest.ID, {
      limit: filteredRequest.Limit,
      skip: filteredRequest.Skip,
    });
  ...
  public static async handleSynchronizeCarCatalogs(
    action: ServerAction,
    req: Request,
    res: Response,
    next: NextFunction
    ...
    // Get the lock
    const syncCarCatalogsLock = await LockingHelper.acquireSyncCarCatalogsLock(
  ...
  public static async handleGetCarMakers(
    action: ServerAction,
    req: Request,
    res: Response,
    next: NextFunction
  ...
  public static async handleCreateCar(
    action: ServerAction,
    req: Request,
    res: Response,
    next: NextFunction
    ...
    await AuthorizationService.checkAndGetCarAuthorizations(
      ...
      {},
      Action.CREATE,
      filteredRequest as Car
    );
    // Check and get Car Catalog
    await UtilsService.checkAndGetCarCatalogAuthorization(
      req.tenant,
      req.user,
      filteredRequest.carCatalogID,
      Action.READ,
      action,
      filteredRequest as Car
    );
    // Car already exits
    const car = await CarStorage.getCarByVinLicensePlate(
      req.tenant,
      filteredRequest.licensePlate,
      filteredRequest.vin
    );
    if (car) {
      throw new AppError({
    ...
    if (filteredRequest.userID) {
      ...
      if (filteredRequest.default) {
        ...
        const defaultCar = await CarStorage.getDefaultUserCar(
          req.tenant,
          filteredRequest.userID,
          {},
          ['id']
  ...
  public static async handleUpdateCar(
    action: ServerAction,
    req: Request,
    res: Response,
    next: NextFunction
  ...
  public static async handleGetCars(
    action: Action,
    req: Request,
    res: Response,
    next: NextFunction
  ...
  public static async handleGetCar(
    action: ServerAction,
    req: Request,
    res: Response,
    next: NextFunction
  ...
  public static async handleDeleteCar(
    action: ServerAction,
    req: Request,
    res: Response,
    next: NextFunction
  ...
  private static async setDefaultCarForUser(tenant: Tenant, userID: string) {
    ...
    const defaultCars = await CarStorage.getCars(
      tenant,
      { userIDs: [userID] },
