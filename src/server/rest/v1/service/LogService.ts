...
export default class LogService {
  public static async handleGetLogs(
    action: ServerAction,
    req: Request,
    res: Response,
    next: NextFunction
  ...
  public static async handleExportLogs(
    action: ServerAction,
    req: Request,
    res: Response,
    next: NextFunction
  ...
  public static async handleGetLog(
    action: ServerAction,
    req: Request,
    res: Response,
    next: NextFunction
  ...
  private static async getLogs(
    req: Request,
    filteredRequest: HttpLogsGetRequest
    ...
    if (filteredRequest.WithAuth) {
      await AuthorizationService.addLogsAuthorizations(
        req.tenant,
        req.user,
        logs as LogDataResult,
        authorizations
      );
    }
    return logs;
