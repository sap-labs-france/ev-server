...
// pragma import ERPService from '../../../integration/pricing/convergent-charging/ERPService';
...
export default class UserService {
  ...
  // pragma public static async handleGetUserInvoice(action: ServerAction, req: Request, res: Response, next: NextFunction): Promise<void> {
  //   // Filter
  //   const id = UserSecurity.filterUserByIDRequest(req.query);
  //   // User mandatory
  //   if (!id) {
