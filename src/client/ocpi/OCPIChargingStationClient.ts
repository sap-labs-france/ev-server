import {
  ...
  OCPPGetCompositeScheduleStatus,
...
export default class OCPIChargingStationClient extends ChargingStationClient {
  ...
  async remoteStartTransaction(
    ...
    const commandResponse = await this.ocpiClient.remoteStartSession(
    ...
    return {
      status:
        commandResponse && commandResponse.result === OCPICommandResponseType.ACCEPTED
          ? OCPPRemoteStartStopStatus.ACCEPTED
          : OCPPRemoteStartStopStatus.REJECTED,
    };
  }
