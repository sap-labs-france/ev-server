  ...
  admin: {
    grants: [
      ...
      { resource: Entity.BILLING, action: [Action.CHECK_CONNECTION, Action.CLEAR_BILLING_TEST_DATA] },
      {
        ...
        attributes: [
          'id', 'accountExternalID', 'businessOwnerID', 'user.id', 'user.firstName', 'user.name', 'user.email', 'status'
        ]
      },
      {
        ...
        attributes: [
          ...
          'platformFeeData.feeAmount', 'platformFeeData.feeTaxAmount', 'platformFeeData.invoiceExternalID', 'platformFeeData.taxExternalID', 'currency'
        ]
      },
