import {
  AssignedSitesDynamicAuthorizationDataSourceData,
...
export default class AssignedSitesDynamicAuthorizationDataSource extends DynamicAuthorizationDataSource<AssignedSitesDynamicAuthorizationDataSourceData> {
