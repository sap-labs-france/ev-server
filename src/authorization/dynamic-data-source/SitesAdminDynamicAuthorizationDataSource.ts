import {
  ...
  SitesAdminDynamicAuthorizationDataSourceData,
...
export default class SitesAdminDynamicAuthorizationDataSource extends DynamicAuthorizationDataSource<SitesAdminDynamicAuthorizationDataSourceData> {
