...
export default class Authorizations {
  ...
  public static async canRefundTransaction(
  ...
  public static async canStartTransaction(
    loggedUser: UserToken,
  ...
  public static async canStopTransaction(
    loggedUser: UserToken,
    transaction: Transaction
  ): Promise<boolean> {
    if (!transaction) {
  ...
  public static async getAuthorizedSiteIDs(
    tenant: Tenant,
    userToken: UserToken,
  ...
  public static async getAuthorizedSiteAdminIDs(
    tenant: Tenant,
    userToken: UserToken,
    requestedSites?: string[]
  ): Promise<string[]> {
  ...
  public static async buildUserToken(tenant: Tenant, user: User, tags: Tag[]): Promise<UserToken> {
    ...
    // Get User's site
    const userSites = (
      await UserStorage.getUserSites(tenant, { userIDs: [user.id] }, Constants.DB_PARAMS_MAX_LIMIT)
    ).result;
    ...
    const rolesACL = Authorizations.getAuthGroupsFromUser(
      user.role,
      siteAdminIDs.length,
      siteOwnerIDs.length
    );
  ...
  public static async canReadTransaction(
    loggedUser: UserToken,
    transaction: Transaction
  ): Promise<boolean> {
    if (!transaction) {
  ...
  public static async canUpdateTransaction(
    loggedUser: UserToken,
    transaction: Transaction
  ): Promise<boolean> {
    if (!transaction) {
  ...
  public static async canUpdateChargingStation(
    loggedUser: UserToken,
    siteID: string
  ): Promise<boolean> {
  ...
  public static async canDeleteChargingStation(
    loggedUser: UserToken,
    siteID: string
  ): Promise<boolean> {
  ...
  public static async canListUsers(
    loggedUser: UserToken,
  ...
  public static async canListUsersInErrors(
    loggedUser: UserToken,
    authContext?: AuthorizationContext
  ): Promise<AuthorizationResult> {
  ...
  public static async canImportTags(
    loggedUser: UserToken,
    authContext?: AuthorizationContext
  ): Promise<AuthorizationResult> {
  ...
  public static async canExportTags(
    loggedUser: UserToken,
    authContext?: AuthorizationContext
  ): Promise<AuthorizationResult> {
  ...
  public static async canReadUser(
    loggedUser: UserToken,
    authContext?: AuthorizationContext
  ): Promise<AuthorizationResult> {
  ...
  public static async canImportUsers(
    loggedUser: UserToken,
    authContext?: AuthorizationContext
  ): Promise<AuthorizationResult> {
  ...
  public static async canExportUsers(
    loggedUser: UserToken,
    authContext?: AuthorizationContext
  ): Promise<AuthorizationResult> {
  ...
  public static async canUpdateUser(
    loggedUser: UserToken,
    authContext?: AuthorizationContext
  ): Promise<AuthorizationResult> {
  ...
  public static async canDeleteUser(
    loggedUser: UserToken,
    authContext?: AuthorizationContext
  ): Promise<AuthorizationResult> {
  ...
  public static async canListSites(
    loggedUser: UserToken,
    authContext?: AuthorizationContext
  ): Promise<AuthorizationResult> {
  ...
  public static async canReadSite(
    loggedUser: UserToken,
    authContext?: AuthorizationContext
  ): Promise<AuthorizationResult> {
  ...
  public static async canCreateSite(
    loggedUser: UserToken,
    authContext?: AuthorizationContext
  ): Promise<AuthorizationResult> {
  ...
  public static async canUpdateSite(
    loggedUser: UserToken,
    authContext?: AuthorizationContext
  ): Promise<AuthorizationResult> {
  ...
  public static async canDeleteSite(
    loggedUser: UserToken,
    authContext?: AuthorizationContext
  ): Promise<AuthorizationResult> {
  ...
  public static async canReadSetting(
    loggedUser: UserToken,
  ...
  public static async canCreateRegistrationToken(
    loggedUser: UserToken,
    siteID: string
  ): Promise<boolean> {
  ...
  public static async canReadRegistrationToken(
    loggedUser: UserToken,
    siteID: string
  ): Promise<boolean> {
  ...
  public static async canDeleteRegistrationToken(
    loggedUser: UserToken,
    siteID: string
  ): Promise<boolean> {
  ...
  public static async canUpdateRegistrationToken(
    loggedUser: UserToken,
    siteID: string
  ): Promise<boolean> {
  ...
  public static async canReadChargingProfile(
    loggedUser: UserToken,
    siteID: string
  ): Promise<boolean> {
  ...
  public static async canUpdateSiteArea(
    loggedUser: UserToken,
    authContext?: AuthorizationContext
  ): Promise<AuthorizationResult> {
  ...
  public static async canSynchronizeCarCatalogs(
    loggedUser: UserToken,
    authContext?: AuthorizationContext
  ): Promise<AuthorizationResult> {
  ...
  public static async canSynchronizeUserBilling(
    loggedUser: UserToken,
    authContext?: AuthorizationContext
  ): Promise<AuthorizationResult> {
    return Authorizations.can(
      loggedUser,
      Entity.USER,
  ...
  public static async canReadInvoiceBilling(
    loggedUser: UserToken,
    userID: string
  ): Promise<boolean> {
  ...
  public static async canDownloadInvoiceBilling(
    loggedUser: UserToken,
    userID: string
  ): Promise<boolean> {
  ...
  public static async canEndUserReportError(
    loggedUser: UserToken,
    authContext?: AuthorizationContext
  ): Promise<AuthorizationResult> {
  ...
  public static async canCreatePaymentMethod(
    loggedUser: UserToken,
    userID: string
  ): Promise<boolean> {
  ...
  public static async can(
    ...
    const authDefinition = AuthorizationsManager.getInstance();
    const result = await authDefinition.canPerformAction(
      loggedUser.rolesACL,
      entity,
      action,
      context
    ...
    if (!result.authorized && Authorizations.getConfiguration().debug) {
      void Logging.logInfo({
        ...
        message: `Role ${
          loggedUser.role
        } Cannot ${action} on ${entity} with context ${JSON.stringify(context)}`,
      });
    }
    return result;
  }

  public static isChargingStationValidInOrganization(
    action: ServerAction,
    tenant: Tenant,
    chargingStation: ChargingStation
  ): boolean {
  ...
  public static async getSiteAdminSiteIDs(tenant: Tenant, userToken: UserToken): Promise<string[]> {
    ...
    )) as SitesAdminDynamicAuthorizationDataSource;
  ...
  public static async getAssignedSiteIDs(tenant: Tenant, userToken: UserToken): Promise<string[]> {
    ...
    )) as AssignedSitesDynamicAuthorizationDataSource;
    return userAssignedSiteDataSource.getData().siteIDs;
  }

  public static async checkOCPIAuthorizedUser(
    action: ServerAction,
    tenant: Tenant,
    chargingStation: ChargingStation,
    transaction: Transaction,
    ...
    if (!Utils.isTenantComponentActive(tenant, TenantComponents.OCPI)) {
      throw new BackendError({
        ...
        action,
        module: MODULE_NAME,
        method: 'checkOCPIAuthorizedUser',
    ...
    const connector = transaction?.connectorId
      ? Utils.getConnectorFromID(chargingStation, transaction.connectorId)
      : Utils.getConnectorFromID(chargingStation, 1);
    switch (authAction) {
      // OCPP Authorize
      case Action.AUTHORIZE:
        // Retrieve Authorization ID from Charging Station (Remote Start)
        user.authorizationID =
          await Authorizations.checkAndGetOCPIAuthorizationIDFromIOPRemoteStartTransaction(
            action,
            tenant,
            chargingStation,
            connector,
  ...
  public static notifyUnknownBadgeHasBeenUsed(
    ...
    // Notify (Async)
    NotificationHandler.sendUnknownUserBadged(tenant, Utils.generateUUID(), chargingStation, {
  ...
  public static async checkAndGetOICPAuthorizedUser(
    action: ServerAction,
    tenant: Tenant,
    transaction: Transaction,
    tagID: string
    ...
    if (Utils.isTenantComponentActive(tenant, TenantComponents.OICP)) {
      ...
      if (!oicpClient) {
        throw new BackendError({
          action,
          module: MODULE_NAME,
          method: 'checkAndGetOICPAuthorizedUser',
      ...
      if (response?.AuthorizationStatus === OICPAuthorizationStatus.Authorized) {
        const virtualOICPUser = await UserStorage.getUserByEmail(
          tenant,
          Constants.OICP_VIRTUAL_USER_EMAIL
        );
  ...
  public static async checkAndGetAuthorizedTag(
    action: ServerAction,
    tenant: Tenant,
    chargingStation: ChargingStation,
    tagID: string
    ...
    if (tag) {
      ...
      if (!tag.active) {
        throw new BackendError({
          ...
          module: MODULE_NAME,
          method: 'checkAndGetAuthorizedTag',
          user: tag.user,
          detailedMessages: { tag },
        });
      }
    ...
    if (!Utils.isEmptyArray(authorizations.result)) {
      ...
      for (const authorization of authorizations.result) {
        if (authorization.authorizationId) {
          ...
          const ocpiTransaction = await TransactionStorage.getOCPITransactionByAuthorizationID(
            tenant,
  ...
  private static async checkAndGetOCPIAuthorizationIDFromIOPRemoteStartTransaction(
    action: ServerAction,
    tenant: Tenant,
    chargingStation: ChargingStation,
    connector: Connector,
          ...
          if (remoteAuthorization.tagId === tag.ocpiToken?.uid) {
            await Logging.logDebug({
              ...
              message: `${Utils.buildConnectorInfo(
                ...
                transaction?.id
              )} Valid Remote Authorization found for Tag ID '${tag.ocpiToken.uid}'`,
              module: MODULE_NAME,
              method: 'checkOCPIAuthorizedUser',
  ...
  private static getAuthGroupsFromUser(
    userRole: string,
    sitesAdminCount: number,
    sitesOwnerCount: number
  ): string[] {
  ...
  private static async canPerformAction(
    loggedUser: UserToken,
    entity: Entity,
    action: Action,
    context?: AuthorizationContext
