...
class Logging {
	...
	// Get Logs
	static getLogs(dateFrom, level, type, chargingStation, searchValue, action, numberOfLogs, sortDate) {
		return global.storage.getLogs(dateFrom, level, type, chargingStation, searchValue, action, numberOfLogs, sortDate);
	}
