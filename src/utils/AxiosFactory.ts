...
export default class AxiosFactory {
  ...
  public static getAxiosInstance(
    ...
    instanceConfiguration.axiosConfig =
      instanceConfiguration.axiosConfig ?? ({} as AxiosRequestConfig);
    // Set timeout
    instanceConfiguration.axiosConfig.timeout =
      instanceConfiguration.axiosConfig.timeout ??
      Configuration.getAxiosConfig()?.timeoutSecs * 1000;
    // Create
    ...
    AxiosFactory.applyAxiosRetryConfiguration(
      axiosInstance,
      instanceConfiguration.axiosRetryConfig
    );
    return axiosInstance;
  }

  private static applyAxiosRetryConfiguration(
    ...
    axiosRetryConfig.retryCondition =
      axiosRetryConfig.retryCondition ??
      AxiosFactory.isNetworkOrDefaultIdempotentRequestError.bind(this);
