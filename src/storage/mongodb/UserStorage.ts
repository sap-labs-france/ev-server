...
export default class UserStorage {
  public static async getEndUserLicenseAgreement(tenant: Tenant, language = 'en'): Promise<Eula> {
    ...
    // Read DB
    const eulasMDB = (await global.database
      .getCollection<any>(tenant.id, 'eulas')
  ...
  public static async getUserByTagID(
    tenant: Tenant,
    tagID: string = Constants.UNKNOWN_STRING_ID
  ): Promise<User> {
  ...
  public static async getUserByEmail(
    tenant: Tenant,
    email: string = Constants.UNKNOWN_STRING_ID
  ): Promise<User> {
    const userMDB = await UserStorage.getUsers(
      tenant,
      {
        email: email,
      },
  ...
  public static async getUserByPasswordResetHash(
    tenant: Tenant,
    passwordResetHash: string = Constants.UNKNOWN_STRING_ID
  ): Promise<User> {
    const userMDB = await UserStorage.getUsers(
      tenant,
      {
  ...
  public static async getUser(
    ...
    params: { withImage?: boolean; siteIDs?: string[] } = {},
  ...
  public static async getUserImage(tenant: Tenant, id: string): Promise<Image> {
    ...
    DatabaseUtils.checkTenantObject(tenant);
    // Read DB
    const userImageMDB = await global.database
      .getCollection<{ _id: ObjectId; image: string }>(tenant.id, 'userimages')
    ...
    return {
      id: id,
      image: userImageMDB ? userImageMDB.image : null,
    };
  }

  public static async removeSitesFromUser(
    tenant: Tenant,
    userID: string,
    siteIDs: string[]
  ): Promise<void> {
  ...
  public static async addSitesToUser(
    tenant: Tenant,
    userID: string,
    siteIDs: string[]
  ): Promise<void> {
  ...
  public static async clearUserSiteAdmin(tenant: Tenant, userID: string): Promise<void> {
    ...
    await Logging.traceDatabaseRequestEnd(tenant, MODULE_NAME, 'clearUserSiteAdmin', startTime, {
      userID,
    });
  }

  public static async addSiteToUser(
    tenant: Tenant,
    userID: string,
    siteID: string
  ): Promise<string> {
  ...
  public static async saveUser(
    ...
    const userMDB: any = {
      ...
      notifications: {
        sendSessionStarted: userToSave.notifications
          ? Utils.convertToBoolean(userToSave.notifications.sendSessionStarted)
          : false,
        sendOptimalChargeReached: userToSave.notifications
          ? Utils.convertToBoolean(userToSave.notifications.sendOptimalChargeReached)
          : false,
        sendEndOfCharge: userToSave.notifications
          ? Utils.convertToBoolean(userToSave.notifications.sendEndOfCharge)
          : false,
        sendEndOfSession: userToSave.notifications
          ? Utils.convertToBoolean(userToSave.notifications.sendEndOfSession)
          : false,
        sendUserAccountStatusChanged: userToSave.notifications
          ? Utils.convertToBoolean(userToSave.notifications.sendUserAccountStatusChanged)
          : false,
        sendNewRegisteredUser: userToSave.notifications
          ? Utils.convertToBoolean(userToSave.notifications.sendNewRegisteredUser)
          : false,
        sendUnknownUserBadged: userToSave.notifications
          ? Utils.convertToBoolean(userToSave.notifications.sendUnknownUserBadged)
          : false,
        sendChargingStationStatusError: userToSave.notifications
          ? Utils.convertToBoolean(userToSave.notifications.sendChargingStationStatusError)
          : false,
        sendChargingStationRegistered: userToSave.notifications
          ? Utils.convertToBoolean(userToSave.notifications.sendChargingStationRegistered)
          : false,
        sendOcpiPatchStatusError: userToSave.notifications
          ? Utils.convertToBoolean(userToSave.notifications.sendOcpiPatchStatusError)
          : false,
        sendOicpPatchStatusError: userToSave.notifications
          ? Utils.convertToBoolean(userToSave.notifications.sendOicpPatchStatusError)
          : false,
        sendUserAccountInactivity: userToSave.notifications
          ? Utils.convertToBoolean(userToSave.notifications.sendUserAccountInactivity)
          : false,
        sendPreparingSessionNotStarted: userToSave.notifications
          ? Utils.convertToBoolean(userToSave.notifications.sendPreparingSessionNotStarted)
          : false,
        sendOfflineChargingStations: userToSave.notifications
          ? Utils.convertToBoolean(userToSave.notifications.sendOfflineChargingStations)
          : false,
        sendBillingSynchronizationFailed: userToSave.notifications
          ? Utils.convertToBoolean(userToSave.notifications.sendBillingSynchronizationFailed)
          : false,
        sendBillingPeriodicOperationFailed: userToSave.notifications
          ? Utils.convertToBoolean(userToSave.notifications.sendBillingPeriodicOperationFailed)
          : false,
        sendSessionNotStarted: userToSave.notifications
          ? Utils.convertToBoolean(userToSave.notifications.sendSessionNotStarted)
          : false,
        sendCarCatalogSynchronizationFailed: userToSave.notifications
          ? Utils.convertToBoolean(userToSave.notifications.sendCarCatalogSynchronizationFailed)
          : false,
        sendEndUserErrorNotification: userToSave.notifications
          ? Utils.convertToBoolean(userToSave.notifications.sendEndUserErrorNotification)
          : false,
        sendComputeAndApplyChargingProfilesFailed: userToSave.notifications
          ? Utils.convertToBoolean(
              userToSave.notifications.sendComputeAndApplyChargingProfilesFailed
            )
          : false,
        sendBillingNewInvoice: userToSave.notifications
          ? Utils.convertToBoolean(userToSave.notifications.sendBillingNewInvoice)
          : false,
        sendAccountVerificationNotification: userToSave.notifications
          ? Utils.convertToBoolean(userToSave.notifications.sendAccountVerificationNotification)
          : false,
        sendAdminAccountVerificationNotification: userToSave.notifications
          ? Utils.convertToBoolean(
              userToSave.notifications.sendAdminAccountVerificationNotification
            )
          : false,
      },
    };
    if (userToSave.address) {
      userMDB.address = {
        ...
        coordinates: Utils.hasValidGpsCoordinates(userToSave.address.coordinates)
          ? userToSave.address.coordinates.map((coordinate) => Utils.convertToFloat(coordinate))
          : [],
      };
    }
    ...
    await global.database
      ...
      .findOneAndUpdate(userFilter, { $set: userMDB }, { upsert: true, returnDocument: 'after' });
  ...
  public static async saveImportedUser(
    tenant: Tenant,
    importedUserToSave: ImportedUser
  ): Promise<string> {
    const startTime = Logging.traceDatabaseRequestStart();
    const userMDB = {
      _id: importedUserToSave.id
        ? DatabaseUtils.convertToObjectID(importedUserToSave.id)
        : new ObjectId(),
    ...
    await global.database
      .getCollection<any>(tenant.id, 'importedusers')
      .findOneAndUpdate(
        { _id: userMDB._id },
        { $set: userMDB },
  ...
  public static async saveImportedUsers(
    tenant: Tenant,
    importedUsersToSave: ImportedUser[]
  ): Promise<number> {
    const startTime = Logging.traceDatabaseRequestStart();
    ...
    const result = await global.database
      .getCollection<any>(tenant.id, 'importedusers')
      .insertMany(importedUsersToSaveMDB, { ordered: false });
    await Logging.traceDatabaseRequestEnd(
      tenant,
      MODULE_NAME,
      'saveImportedUsers',
  ...
  public static async deleteImportedUser(tenant: Tenant, importedUserID: string): Promise<void> {
    ...
    await Logging.traceDatabaseRequestEnd(tenant, MODULE_NAME, 'deleteImportedUser', startTime, {
      id: importedUserID,
    });
  }
  ...
  public static async saveUserPassword(
    tenant: Tenant,
    userID: string,
    params: {
      password?: string;
    ...
    await global.database
      .getCollection<any>(tenant.id, 'users')
      .findOneAndUpdate({ _id: DatabaseUtils.convertToObjectID(userID) }, { $set: params });
    await Logging.traceDatabaseRequestEnd(tenant, MODULE_NAME, 'saveUserPassword', startTime, {
      params,
    });
  }

  public static async saveUserStatus(
    tenant: Tenant,
    userID: string,
    status: UserStatus
  ): Promise<void> {
    ...
    await global.database
      .getCollection<any>(tenant.id, 'users')
      .findOneAndUpdate({ _id: DatabaseUtils.convertToObjectID(userID) }, { $set: { status } });
    await Logging.traceDatabaseRequestEnd(tenant, MODULE_NAME, 'saveUserStatus', startTime, {
      status,
    });
  }

  public static async saveStartTransactionData(
    tenant: Tenant,
    userID: string,
    ...
    await Logging.traceDatabaseRequestEnd(
      tenant,
      MODULE_NAME,
      'saveUserLastSelectedCarID',
      startTime,
      { startTransactionData }
    );
  }

  public static async saveUserMobileData(
    tenant: Tenant,
    userID: string,
    params: UserMobileData
  ): Promise<void> {
    const startTime = Logging.traceDatabaseRequestStart();
    DatabaseUtils.checkTenantObject(tenant);
    // Validate
  ...
  public static async saveUserMobilePhone(
    tenant: Tenant,
    userID: string,
    params: { mobile?: string; phone?: string }
  ): Promise<void> {
    const startTime = Logging.traceDatabaseRequestStart();
    DatabaseUtils.checkTenantObject(tenant);
    // Modify and return the modified document
  ...
  public static async saveUserRole(tenant: Tenant, userID: string, role: string): Promise<void> {
    ...
    await global.database
      .getCollection<any>(tenant.id, 'users')
      .findOneAndUpdate({ _id: DatabaseUtils.convertToObjectID(userID) }, { $set: { role } });
    await Logging.traceDatabaseRequestEnd(tenant, MODULE_NAME, 'saveUserRole', startTime, { role });
  }

  public static async saveUserEULA(
    tenant: Tenant,
    userID: string,
    params: { eulaAcceptedHash: string; eulaAcceptedOn: Date; eulaAcceptedVersion: number }
  ): Promise<void> {
    const startTime = Logging.traceDatabaseRequestStart();
    DatabaseUtils.checkTenantObject(tenant);
    // Modify and return the modified document
  ...
  public static async saveUserAccountVerification(
    tenant: Tenant,
    userID: string,
    params: { verificationToken?: string; verifiedAt?: Date }
  ): Promise<void> {
    const startTime = Logging.traceDatabaseRequestStart();
    DatabaseUtils.checkTenantObject(tenant);
    // Modify and return the modified document
    ...
    await Logging.traceDatabaseRequestEnd(
      tenant,
      MODULE_NAME,
      'saveUserAccountVerification',
      startTime,
      params
    );
  }

  public static async saveUserAdminData(
    tenant: Tenant,
    userID: string,
    params: {
      plateID?: string;
    ...
    await global.database
      .getCollection<any>(tenant.id, 'users')
      .findOneAndUpdate({ _id: DatabaseUtils.convertToObjectID(userID) }, { $set: updatedUserMDB });
    await Logging.traceDatabaseRequestEnd(
      tenant,
      MODULE_NAME,
      'saveUserAdminData',
  ...
  public static async saveUserBillingData(
    tenant: Tenant,
    userID: string,
  ...
  public static async saveUserImage(
    tenant: Tenant,
    userID: string,
    userImageToSave: string
  ): Promise<void> {
    const startTime = Logging.traceDatabaseRequestStart();
    DatabaseUtils.checkTenantObject(tenant);
    if (!userID) {
    ...
    // Modify and return the modified document
    await global.database
      .getCollection<any>(tenant.id, 'userimages')
      .findOneAndUpdate(
        { _id: DatabaseUtils.convertToObjectID(userID) },
  ...
  public static async getUsers(
    ...
    if (params.siteIDs || params.excludeSiteID) {
      ...
      if (params.excludeSiteID) {
        aggregation.push({
          $match: {
            'siteusers.siteID': { $ne: DatabaseUtils.convertToObjectID(params.excludeSiteID) },
          },
        });
      }
    }
    ...
    // Count Records
    const usersCountMDB = (await global.database
      .getCollection<any>(tenant.id, 'users')
    ...
    // Read DB
    const usersMDB = (await global.database
      .getCollection<any>(tenant.id, 'users')
  ...
  public static async getImportedUsers(
    tenant: Tenant,
    params: { status?: ImportStatus; search?: string },
    dbParams: DbParams,
    projectFields?: string[]
  ): Promise<DataResult<ImportedUser>> {
    const startTime = Logging.traceDatabaseRequestStart();
    DatabaseUtils.checkTenantObject(tenant);
    // Clone before updating the values
    dbParams = Utils.cloneObject(dbParams);
    ...
    // Count Records
    const usersImportCountMDB = (await global.database
      .getCollection<any>(tenant.id, 'importedusers')
      .aggregate([...aggregation, { $count: 'count' }], DatabaseUtils.buildAggregateOptions())
      .toArray()) as DatabaseCount[];
    // Check if only the total count is requested
    ...
    DatabaseUtils.projectFields(aggregation, projectFields);
    // Read DB
    const usersImportMDB = (await global.database
      .getCollection<any>(tenant.id, 'importedusers')
      .aggregate<any>(aggregation, DatabaseUtils.buildAggregateOptions())
  ...
  public static async getUsersInError(
    tenant: Tenant,
    params: { search?: string; roles?: string[]; errorTypes?: string[] },
    dbParams: DbParams,
    projectFields?: string[]
  ): Promise<DataResult<UserInError>> {
    const startTime = Logging.traceDatabaseRequestStart();
    DatabaseUtils.checkTenantObject(tenant);
    // Clone before updating the values
    dbParams = Utils.cloneObject(dbParams);
    ...
    for (const type of params.errorTypes) {
      if (
        (type === UserInErrorType.NOT_ASSIGNED &&
          !Utils.isTenantComponentActive(tenant, TenantComponents.ORGANIZATION)) ||
        (type === UserInErrorType.FAILED_BILLING_SYNCHRO &&
  ...
  public static async deleteUser(tenant: Tenant, id: string): Promise<void> {
    ...
    // Delete Connections
    await global.database
      .getCollection<any>(tenant.id, 'connections')
      .deleteMany({ userId: DatabaseUtils.convertToObjectID(id) });
    // Delete User
    await global.database
      .getCollection<any>(tenant.id, 'users')
  ...
  public static async getUserSites(
    tenant: Tenant,
    params: {
      search?: string;
      userIDs: string[];
    ...
    // Count Records
    const userSitesCountMDB = (await global.database
      .getCollection<any>(tenant.id, 'siteusers')
      .aggregate([...aggregation, { $count: 'count' }], DatabaseUtils.buildAggregateOptions())
      .toArray()) as DatabaseCount[];
    // Check if only the total count is requested
    ...
    DatabaseUtils.projectFields(aggregation, projectFields);
    // Read DB
    const userSitesMDB = (await global.database
      .getCollection<any>(tenant.id, 'siteusers')
      .aggregate<any>(aggregation, DatabaseUtils.buildAggregateOptions())
      .toArray()) as UserSite[];
    await Logging.traceDatabaseRequestEnd(
      ...
      case UserInErrorType.INACTIVE_USER_ACCOUNT: {
        ...
        if (moment(someMonthsAgo).isValid()) {
          return [
            {
              $match: {
                $and: [{ eulaAcceptedOn: { $lte: someMonthsAgo } }, { role: 'B' }],
              },
            },
            {
        ...
        return [
          {
            $match: {
              $or: [
                { 'billingData.hasSynchroError': { $eq: true } },
                {
                  $and: [
                    { billingData: { $exists: true } },
                    { 'billingData.hasSynchroError': { $exists: false } },
                  ],
                },
              ],
            },
  ...
  private static getEndUserLicenseAgreementFromFile(language = 'en'): string {
    ...
    let eulaText = null;
    try {
      eulaText = fs.readFileSync(
        `${global.appRoot}/assets/eula/${language}/end-user-agreement.html`,
        'utf8'
      );
    } catch (error) {
      eulaText = fs.readFileSync(
        `${global.appRoot}/assets/eula/en/end-user-agreement.html`,
        'utf8'
      );
    }
    // Build Front End URL
    const frontEndURL =
      centralSystemFrontEndConfig.protocol +
      '://' +
      centralSystemFrontEndConfig.host +
      ':' +
      centralSystemFrontEndConfig.port.toString();
    // Parse the auth and replace values
    eulaText = Mustache.render(eulaText, {
      chargeAngelsURL: frontEndURL,
    });
    void Logging.traceDatabaseRequestEnd(
      Constants.DEFAULT_TENANT_OBJECT,
      MODULE_NAME,
      'getEndUserLicenseAgreementFromFile',
      startTime,
      eulaText
    );
    return eulaText;
