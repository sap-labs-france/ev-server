...
export enum DynamicAuthorizationFilterName {
  ...
  SITE_ADMIN_SITE_AREAS = 'SiteAdminSiteAreas',
}
...
export interface SiteAdminSiteAreasDynamicAuthorizationDataSourceData extends DynamicAuthorizationDataSourceData {
  siteAreaIDs?: string[];
}
