import { BillingAccount, BillingInvoice, BillingPaymentMethod, BillingTax } from './Billing';
...
export type EntityData = Car|User|Company|Site|SiteArea|Tag|CarCatalog|ChargingStation|PricingDefinition|Log|RegistrationToken|BillingInvoice|BillingPaymentMethod|BillingTax|Setting|BillingAccount|ChargingProfile|Connector|ChargingStationTemplate;
