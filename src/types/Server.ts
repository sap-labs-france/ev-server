...
export enum ServerAction {
  ...
  REST_CHARGING_STATIONS_GENERATE_QRCODE = 'chargingstations/:id/connectors/:connectorId/qrcode',
  ...
  REST_CHARGING_STATIONS_DIAGNOSTICS = 'chargingstations/:id/compositeschedule',
  REST_CHARGING_STATIONS_DOWNLOAD_FIRMWARE = 'chargingstations/firmware/:name',
  REST_CHARGING_STATIONS_FIRMWARE = 'chargingstations/:id/firmware/:firmwareId',
  ...
  REST_CHARGING_PROFILES = 'chargingstations/profiles',
  REST_CHARGING_PROFILE = 'chargingstations/profiles/:id',
  REST_PING = 'ping',
