export enum HTTPError {
  ...
  CHARGING_PROFILE_NOT_EXCEPTED = 554,
}
...
export enum HTTPUserError {
  EMAIL_ALREADY_EXIST_ERROR = 510,
  EULA_ERROR = 520,
  ACCOUNT_ALREADY_ACTIVE_ERROR = 530,
  TAG_ID_ALREADY_USED_ERROR = 540,
  LOCKED_ERROR = 570,
  NO_BADGE_ERROR = 570,
  ACCOUNT_INACTIVE_ERROR = 580,
  ACCOUNT_PENDING_ERROR = 590,
}
