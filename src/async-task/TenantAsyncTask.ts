  ...
  protected async executeAsyncTask(): Promise<void> {
    ...
    if (
      ...
      await Logging.logInfo({
        ...
        message: `Tasks on envirnoment: '${currentTaskEnv}' are disabled, '${
          this.getAsyncTask().name
        }~${this.getCorrelationID()}' will not run...`,
      });
    }
      ...
      for (const tenant of tenants.result) {
        ...
        if (tenant.taskExecutionEnv && tenant.taskExecutionEnv !== currentTaskEnv) {
          await Logging.logInfo({
            ...
            message: `The Task '${
              this.getAsyncTask().name
            }~${this.getCorrelationID()}' is skipped for Tenant ${Utils.buildTenantName(
              tenant
        ...
        await Logging.logDebug({
          ...
          message: `The Task '${
            this.getAsyncTask().name
          }~${this.getCorrelationID()}~${tenantCorrelationID}' is running for Tenant ${Utils.buildTenantName(
            tenant
          )}...`,
        });
        await Logging.logDebug({
          ...
          message: `The Task '${
            this.getAsyncTask().name
          }~${this.getCorrelationID()}~${tenantCorrelationID}' is running...`,
        });
        try {
          // Hook
          ...
          await Logging.logError({
            ...
            message: `Error while running the Task '${
              this.getAsyncTask().name
            }~${this.getCorrelationID()}~${tenantCorrelationID}' for Tenant ${Utils.buildTenantName(
              tenant
          ...
          await Logging.logError({
            ...
            message: `Error while running the Task '${
              this.getAsyncTask().name
            }~${this.getCorrelationID()}~${tenantCorrelationID}': ${error.message as string}`,
            detailedMessages: { error: error.stack },
          });
        }
        ...
        await Logging.logDebug({
          ...
          message: `The Task '${
            this.getAsyncTask().name
          }~${this.getCorrelationID()}~${tenantCorrelationID}' has been run successfully in ${totalTimeSecsInTenant} secs for Tenant ${Utils.buildTenantName(
            tenant
          )}`,
        });
        await Logging.logDebug({
          ...
          message: `The Task '${
            this.getAsyncTask().name
          }~${this.getCorrelationID()}~${tenantCorrelationID}' has been run successfully in ${totalTimeSecsInTenant} secs`,
        });
      }
    }
  }
